...
class TimePoint(InstanceRegistry, DumpableState):
    ...
    @property
    def _timepoint_basic_dict(self) -> dict:
        """basic dictionary for any TimePoint class or subclass"""
        # todo update this when the dependency diamond is resolved
        return {
    ...
    def as_dict(self) -> dict:
        ...
        return self._timepoint_basic_dict
...
class ActionTimePoint(ExecutionSequence, TimePoint):
    ...
    def as_dict(self) -> dict:
        ...
        dct.update(self._timepoint_basic_dict)
