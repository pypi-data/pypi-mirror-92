...
def write_gifti(filename, arr_list, brain_structure, intent_list=None, color_map=None,
    ...
    :param color_map: Set color map for label gifti's. One of following:

        - None for non-label giftis
        - 'default' for default qualitative colour map
        - dict mapping value to RGBA values otherwise
