...
class TestCatBoostPointwiseRankingModel:
    def test_000_pointwise(self, mocker):
        cpr = CatBoostPointwiseRankingModel(
            ...
            products={
                "PROD001": {"name": "상품001", "context_features": ["context1"]},
                "PROD002": {"name": "상품002", "context_features": ["context2", "context3"]},
                "PROD003": {"name": "상품003", "context_features": ["context3"]},
                "PROD004": {"name": "상품004", "context_features": ["context1", "context2", "context3"]},
            },
            item_type="test_type",
            cutoff=0.5,
        )
    ...
    def test_002_pointwise_all_n(self, mocker):
        ...
        assert cpr.predict([["PROD001", "PROD002", "PROD003"], 4, 5, 6, "N", "N", "N"]) == {
            "items": [
                {"id": "PROD003", "name": "상품003", "type": "test_type", "props": {"context_id": "context_default"}}
            ]
        }
