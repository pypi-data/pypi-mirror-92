...
class MLSTrainable:
    ...
    def fit(
        ...
        - hyperparameters: (optional) (dict) AutoGluon hyperparameters. [공식 문서 참조](https://auto.gluon.ai/stable/api/autogluon.task.html#autogluon.task.TabularPrediction.fit) (기본값: {"GBM": [{}, {"extra_trees": True, "AG_args": {"name_suffix": "XT"}}], "CAT": {}})
        ...
        self.models[0] = self._fit(train_data, eval_metric, hyperparameters)
    ...
    def _fit(self, train_data: pd.DataFrame, eval_metric: str, hyperparameters: Dict[str, Dict[str, Any]]):
