...
setup(
    name="devops-requests",
    version="0.0.2",
    description="REST API wrapper for various DevOps related tools",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://gitlab.com/technology-innovations-lab/open-source/devops-requests",
