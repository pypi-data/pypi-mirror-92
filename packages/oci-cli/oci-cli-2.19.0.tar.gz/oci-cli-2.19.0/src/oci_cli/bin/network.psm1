...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network vcn add-vcn-cidr' = 'cidr-block from-json help if-match vcn-id'
        ...
        'network vcn modify-vcn-cidr' = 'from-json help if-match new-cidr-block original-cidr-block vcn-id'
        'network vcn remove-vcn-cidr' = 'cidr-block from-json help if-match vcn-id'
