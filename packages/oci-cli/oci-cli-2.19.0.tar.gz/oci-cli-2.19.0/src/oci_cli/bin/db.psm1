...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-container-database-dataguard autonomous-database autonomous-database-backup autonomous-database-dataguard autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-patch autonomous-vm-cluster backup backup-destination cloud-exa-infra cloud-vm-cluster console-connection data-guard-association database database-software-image db-home exadata-infrastructure external-backup-job flex-component gi-version key-store maintenance-run node patch patch-history system system-shape upgrade-history version vm-cluster vm-cluster-network'
