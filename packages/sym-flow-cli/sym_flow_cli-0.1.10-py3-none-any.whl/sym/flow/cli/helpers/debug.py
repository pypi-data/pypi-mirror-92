...
from .boto import dir_path_for_uploading, put_public_fileobj
...
def do_upload_terraform_output(dir: str, options: GlobalOptions) -> str:
    ...
    txid, object_path = dir_path_for_uploading(directory / "output", "json")
...
def do_upload_directory(dir: str) -> str:
    directory = Path(dir).resolve()
    txid, object_path = dir_path_for_uploading(directory, "zip")
