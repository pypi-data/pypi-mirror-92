...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, repository=None, content_guard=None, base_path=None, pulp_created=None, repository_version=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
