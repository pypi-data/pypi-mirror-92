...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, content_guard=None, pulp_href=None, repository_version=None, pulp_created=None, repository=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
