...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_href=None, name=None, pulp_created=None, content_guard=None, repository_version=None, base_path=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
