...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, repository=None, name=None, pulp_href=None, content_guard=None, repository_version=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
