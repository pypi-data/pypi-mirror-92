...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_created=None, pulp_href=None, content_guard=None, repository=None, repository_version=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
