...
from convo.shared.data import YAML_FILE_EXTENSIONS, MARKDOWN_FILE_EXTENSIONS
...
def _get_reader(
    ...
    if convo.shared.data.is_likely_markdown_file(filename):
...
async def load_data_from_resource(
    ...
    return await load_data_from_files(
        convo.shared.utils.io.list_files(resource),
        domain,
        template_variables,
        use_e2e,
