    ...
    for field_name in field_name_list:
        ...
        if field_dict['field_delete'] is False:
            ...
            if field_type in {str, float}:
                field_metadata_dict['width'] = field_dict['field_width']
                ...
                if field_type is str and field_dict['field_list'] is False:
                    if field_dict['field_list_width'] and field_dict['field_list_width'] > field_dict['field_width']:
                        field_metadata_dict['width'] = field_dict['field_list_width']
            # get precision (if necessary)
            if field_type == float:
