...
class Variables():
    ...
    def __init__(self):
        ...
        self.misspelled_dict = defaultdict(list)
        for x, y in self.misspelled.items():
            self.misspelled_dict[y].append(x)
...
def spelling_errors(v, l, n):
    ...
    try:
        common = random.choice(list(set(v.misspelled_words).intersection(l)))
    except:
