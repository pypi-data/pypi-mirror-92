...
noreplace = "No replacement found"
...
def dictionary_replacement_verb_form_change(l, n):
    ...
    r = dictionary_replacement(l,n)
    l = verb_form_change(r, n)    
...
def dictionary_replacement_phrase_order_change(l, n):
    ...
    r = dictionary_replacement(l,n)
    l = phrase_order_change(r, n)

    return l

def verb_form_change_insert_determiner(l, n):

    r = verb_form_change(l,n)
    l = dictionary_replacement(r, n)    

    return l


def insert_determiner_verb_form_change(l, n):

    r = insert_determiner(l, n)
    l = verb_form_change(r,n)
