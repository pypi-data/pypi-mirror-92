...
def check_in_range(
    ...
    assert isinstance(min_value, type(max_value)), \
        f'{min_value} and {max_value} should have the same type'
    check_type(par, par_name, type(min_value))
    assert min_value < max_value, \
        f'{min_value} should be less than {max_value}'
    assert isinstance(include_min, bool), type(include_min)
    assert isinstance(include_max, bool), type(include_max)
