...
will not function fully in Binder. However, all other examples, which don't rely on databases/multithreading do work. First
we recommend the quick guide below:
...
* [Market microstructure with tcapy](market_microstructure_with_tcapy.ipynb) - generating results for
