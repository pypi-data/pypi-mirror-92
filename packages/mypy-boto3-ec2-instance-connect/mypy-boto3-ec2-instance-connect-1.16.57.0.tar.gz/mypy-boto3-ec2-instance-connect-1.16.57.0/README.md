...
[boto3.EC2InstanceConnect 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/ec2-instance-connect.html#EC2InstanceConnect) service
compatible with
