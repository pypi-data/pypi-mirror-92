...
[boto3.ServerlessApplicationRepository 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
