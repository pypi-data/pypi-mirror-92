...
class TestIterators(TestBase.TestBase):
    ...
    def testParameterIterators(self):
        ...
        ampl.eval('param x;')
        self.assertEqual(
            len(ampl.getParameters()),
            ampl.getParameters().size()
        )
        self.assertEqual(
            ampl.getParameters().size(),
            len(list(ampl.getParameters()))
        )
    ...
    def testVariableIterators(self):
        ...
        ampl.eval('var x;')
        self.assertEqual(
            len(ampl.getVariables()),
            ampl.getVariables().size()
        )
        self.assertEqual(
            ampl.getVariables().size(),
            len(list(ampl.getVariables()))
        )
    ...
    def testConstraintIterators(self):
        ...
        self.assertEqual(
            ampl.getConstraints().size(),
            len(ampl.getConstraints())
        )
        self.assertEqual(
            ampl.getConstraints().size(),
            len(list(ampl.getConstraints()))
        )
    ...
    def testObjectiveIterators(self):
        ...
        self.assertEqual(
            ampl.getObjectives().size(),
            len(ampl.getObjectives())
        )
        self.assertEqual(
            ampl.getObjectives().size(),
            len(list(ampl.getObjectives()))
        )
        ...
        self.assertEqual(
            ampl.getObjective('c_x').numInstances(),
            len(dict(ampl.getObjective('c_x')))
        )
