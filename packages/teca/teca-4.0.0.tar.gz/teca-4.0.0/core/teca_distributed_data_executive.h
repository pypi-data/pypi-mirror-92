#ifndef teca_distributed_data_executive_h
#define teca_distributed_data_executive_h
...
TECA_SHARED_OBJECT_FORWARD_DECL(teca_distributed_data_executive)
...
*/
class teca_distributed_data_executive : public teca_algorithm_executive
{
public:
    TECA_ALGORITHM_EXECUTIVE_STATIC_NEW(teca_distributed_data_executive)
...
protected:
    teca_distributed_data_executive();
