...
class Kraken_testdata:
    ...
    def base_list(self, qty=3):
        ...
        for i in range(0, qty):
            ...
            records.append(Kraken_testdata(name).base)
        return records
    ...
    def complex(self):
        ...
        record['schema:sub_rec'] = Kraken_testdata('sub_rec').base
        
        record['schema:sub_list'] = Kraken_testdata('sub_list').base_list()
