...
setup(
  ...
  version = '0.2-c',      # Start with a small number and increase it with every change you make
  ...
  package_dir={"":"/home/ecmgs/programacion/GITHUB/"},
  entry_points={
      "console_scripts": ["GTCreator = GTCreator.__main__:__main__"]
    }
)
