...
from .model import DHEConfiguration, P as PCalculationMode, PCalculationMonthlyLoadMode
...
profile_loader.item_with_key(PCalculationMode)((unpack_load("t", "P"), calc_P))
...
profile_loader.item_with_key(PCalculationMonthlyLoadMode)((P_profile_tP, calc_P))
