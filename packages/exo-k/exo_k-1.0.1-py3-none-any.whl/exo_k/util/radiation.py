...
def wavelength_grid_R(lambda_min, lambda_max, R):
    ...
    .. warning::
        The spectral size of the last bin is, in general, not consistent with
        the resolution asked. This is because we chose to force the last point 
        of the grid to be `lambda_max`. 
