...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.4.0-alpha.1611079816+fa855b5b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.4.0-alpha.1611079816+fa855b5b`
                """)
            else:
                raise
