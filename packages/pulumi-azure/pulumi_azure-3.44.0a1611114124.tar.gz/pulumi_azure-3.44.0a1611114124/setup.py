...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.44.0-alpha.1611114124+89b9e18b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.44.0-alpha.1611114124+89b9e18b`
                """)
            else:
                raise
