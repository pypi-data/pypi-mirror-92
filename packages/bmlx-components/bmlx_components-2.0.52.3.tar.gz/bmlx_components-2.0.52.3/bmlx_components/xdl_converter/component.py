...
class XdlConverterSpec(ComponentSpec):
    ...
    OUTPUTS = {
        ...
        "single_machine": ChannelParameter(
            type=custom_artifacts.TextInfo,
            description="是否发布单机版模型",
        ),
    }
...
class XdlConverter(Component):
    ...
    def __init__(
        ...
        single_machine = Channel(
            artifact_type=custom_artifacts.TextInfo,
            artifacts=[custom_artifacts.TextInfo()],
        )
