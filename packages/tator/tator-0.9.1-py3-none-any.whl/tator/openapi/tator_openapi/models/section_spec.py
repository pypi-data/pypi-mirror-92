...
class SectionSpec(object):
    ...
    def __init__(self, annotation_bools=None, lucene_string=None, media_bools=None, name=None, tator_user_sections=None, local_vars_configuration=None):  # noqa: E501
