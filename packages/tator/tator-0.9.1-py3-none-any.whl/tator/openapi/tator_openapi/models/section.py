...
class Section(object):
    ...
    def __init__(self, annotation_bools=None, id=None, lucene_string=None, media_bools=None, name=None, project=None, tator_user_sections=None, local_vars_configuration=None):  # noqa: E501
