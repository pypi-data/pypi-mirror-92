...
class TranscodeSpec(object):
    ...
    def __init__(self, attributes=None, gid=None, md5=None, media_id=None, name=None, section=None, type=None, uid=None, url=None, local_vars_configuration=None):  # noqa: E501
