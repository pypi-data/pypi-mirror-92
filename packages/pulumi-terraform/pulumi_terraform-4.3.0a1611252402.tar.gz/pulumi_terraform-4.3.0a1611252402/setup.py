...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '4.3.0-alpha.1611252402+47e964cc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 4.3.0-alpha.1611252402+47e964cc`
                """)
