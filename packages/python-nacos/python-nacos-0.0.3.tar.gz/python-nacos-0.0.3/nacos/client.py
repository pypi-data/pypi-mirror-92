...
from .listener import SimpleListenerManager, Event
...
class NacosClient:
    ...
    def subscribe(self,
        ...
        subscribe_timer = NacosTimer(name=timer_name, interval=listener_interval, fn=_compare_and_trigger_listener)
