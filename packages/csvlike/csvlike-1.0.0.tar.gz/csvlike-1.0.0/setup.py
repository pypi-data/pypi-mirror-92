...
setup(
    name=__name__,
    url='https://github.com/MikeSmithEU/csvlike/',
    license='MIT',
    version=__version__,
    author=__author__,
    author_email='github@mikesmith.eu',
    maintainer=__author__,
    maintainer_email='github@mikesmith.eu',
    description='Read CSV-like files',
