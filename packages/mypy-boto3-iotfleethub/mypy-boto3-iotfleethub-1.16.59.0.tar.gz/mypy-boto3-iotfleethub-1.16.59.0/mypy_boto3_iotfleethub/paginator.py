...
class ListApplicationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApplications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.59/reference/services/iotfleethub.html#IoTFleetHub.Paginator.ListApplications.paginate)
        """
