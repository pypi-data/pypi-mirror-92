...
if 'sdist' not in dist.commands and compiler.find_library_file([library_path],
    ...
    # the sources.
    if compiler.compiler_type == 'msvc':
        compile_flags = [('/D'+flag).replace('"', '\\"') for flag in ['JSBSIM_VERSION="1.1.3 [GitHub build 246/commit 532107b31a4f74cc1937b7a934136cc7c1998442]"','HAVE_EXPAT_CONFIG_H',]]
    else:
        compile_flags = ['-D'+flag for flag in ['JSBSIM_VERSION="1.1.3 [GitHub build 246/commit 532107b31a4f74cc1937b7a934136cc7c1998442]"','HAVE_EXPAT_CONFIG_H',]]
