...
if 'sdist' not in dist.commands and compiler.find_library_file([library_path],
    ...
    # the sources.
    if compiler.compiler_type == 'msvc':
        compile_flags = [('/D'+flag).replace('"', '\\"') for flag in ['_USE_MATH_DEFINES', 'NOMINMAX', 'JSBSIM_VERSION="1.1.4 [GitHub build 262/commit 366b9d4e35eebbcc95b9eda09f1de8b15564e281]"','HAVE_EXPAT_CONFIG_H',]]
    else:
        compile_flags = ['-D'+flag for flag in ['JSBSIM_VERSION="1.1.4 [GitHub build 262/commit 366b9d4e35eebbcc95b9eda09f1de8b15564e281]"','HAVE_EXPAT_CONFIG_H',]]
