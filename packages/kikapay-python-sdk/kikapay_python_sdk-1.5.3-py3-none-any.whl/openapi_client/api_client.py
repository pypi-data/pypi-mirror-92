...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PaymentsApi()
        api_instance.create_exact_recurring_payment  # this is an instance of the class Endpoint
        api_instance.create_exact_recurring_payment()  # this invokes api_instance.create_exact_recurring_payment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_exact_recurring_payment.callable or self.callable in this class
