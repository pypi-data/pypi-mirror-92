...
def lnet(x_train): # 60000x784 >> 60000 28 28 1
    first=int(math.sqrt(init.X_train.shape[1]))
    x_train=x_train.reshape(init.X_train.shape[0],first,first,1)
    #conv layer1 
    w1=np.random.randint(5,5,1,6)
    b1=np.random.randint(1,1,1,6)
