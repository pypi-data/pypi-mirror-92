...
def configuration() -> bool:
    """
    Local configurations that enhance the usage of the SDK.
...
def list() -> bool:
    """
    List the available KSDK configurations.
    """
...
def set(config: Tuple) -> bool:
    """
    Set a local KSDK configuration.
...
def unset(config: str) -> bool:
    """
    Unset a local KSDK configuration.
...
def encode(value: str) -> bool:
    ...
    e.g.: {command} configuration pip encode 'my_value+/@'
