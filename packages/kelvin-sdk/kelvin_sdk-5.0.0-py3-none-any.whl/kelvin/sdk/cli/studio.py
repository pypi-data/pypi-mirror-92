...
@click.option("--schema-file", "--schema", type=click.Path(), required=False, help=KSDKHelpMessages.studio_schema_file)
@click.option("--input-file", "--input", type=click.Path(), required=True, help=KSDKHelpMessages.studio_input_file)
def start(
    schema_file: str,
    input_file: str,
) -> bool:
