...
def search(query: str) -> List:
    ...
    e.g. {command} datamodel search "my.model"
    """
...
def create(data_model: str, output_dir: str) -> bool:
    ...
    e.g. {command} datamodel create "my.model"
    """
...
def show(data_model: str, version: str) -> List:
    ...
    e.g. {command} datamodel show "my.model" --version=1.0.0
    """
...
def upload(input_dir: str, datamodels: Tuple[str]) -> bool:
    ...
    e.g. {command} datamodel upload --names=my.model:1.0.0
    """
...
def download(name: str, version: str, output_dir: str) -> bool:
    ...
    e.g. {command} datamodel download "my.model" "1.0.0" --output-dir=my_dir/
    """
...
def extract_schema(input_dir: str, output_dir: str, datamodels: Tuple[str]) -> bool:
    ...
    e.g. {command} datamodel extract-schema --input-dir=datamodel/ --output-dir=schemas/
    """
