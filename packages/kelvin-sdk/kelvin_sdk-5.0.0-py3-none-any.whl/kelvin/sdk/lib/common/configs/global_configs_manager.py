...
from kelvin.sdk.lib.common.utils.display_utils import DisplayObject, display_data_entries
...
def global_configurations_list(should_display: bool = False) -> List[DisplayObject]:
    ...
    try:
        ...
        data = [v for k, v in descriptions.items()]
...
def pip_configure() -> bool:
    ...
    pip_configure_guide: str = """
        ...
        Please refer to `{{command}} configuration pip encode` for more details.
        {reset}
