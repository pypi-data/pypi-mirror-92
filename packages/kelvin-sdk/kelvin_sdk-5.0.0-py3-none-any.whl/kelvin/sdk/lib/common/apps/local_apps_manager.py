...
from kelvin.sdk.lib.common.exceptions import AppException, KDockerException
    ...
    try:
        ...
        if not parameters_are_valid:
            error_message = """The provided parameter combination is not valid.
                ...
                Simply type `{{command}} app create` and follow the suggested steps.
            """
        ...
        You may continue its configuration using \"studio\". Refer to \"{{command}} studio --help\" for more information.
        """
...
def build_data_app(
    ...
    configuration: Optional[Sequence[IO]] = None,
    parameters: Optional[Sequence[IO]] = None,
