...
from kelvin.sdk.lib.common.models.apps.kelvin_app import IO, ApplicationFlavour, Connection, DataModel
...
from kelvin.sdk.lib.common.templates.templates_manager import _retrieve_template
...
def migrate_app_configuration(app_dir_path: str, output_file_path: KPath) -> Optional[KelvinAppConfiguration]:
    ...
    system_requirements_path = KPath(app_dir_path) / "sys_requirements.txt"
    ...
    requirements_path: KPath = KPath(app_dir_path) / "requirements.txt"
        ...
        if file.suffix in [".yaml", ".yml"]:
            ...
            try:
                ...
                if "raw" not in name:
                    ...
                    data_model_path.write_yaml(migrated_datamodel)
                    migrated_datamodel = DataModel(
                        name=name,
                        version=version,
            ...
            try:
                ...
                if "raw" in str(datamodel.name):
                    try:
                        ...
                        datamodel.version = remote_datamodel.version
                    except APIError:
