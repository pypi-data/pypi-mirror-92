...
def get_kelvin_app_creation_object(app_creation_parameters: AppCreationParametersObject) -> AppCreationObject:
    ...
    parameters: dict = {
        ...
        "kelvin_app_interface": kelvin_app_interface.value,
        "kelvin_app_lang": kelvin_app_lang.value,
        "kelvin_app_flavour": kelvin_app_flavour.value,
...
def get_legacy_app_building_object(app_dir: str, build_for_upload: bool = False) -> LegacyAppBuildingObjectLegacy:
    ...
    app_lang = ApplicationLanguage(app_config_model.info.platform)
    ...
    base_data_model_builder_image: Optional[str] = app_config_model.sdk.data_model_builder_image
    base_image: Optional[str] = app_config_model.sdk.base_image
