...
class CompanyMetadata(KSDKModel):
    admin_tool: GenericMetadataEntry = Field(None, alias="admin-tool")
    api: GenericMetadataEntry
    authentication: GenericMetadataEntry
    docker: DockerMetadataEntry
    documentation: GenericMetadataEntry
    opcua_websocket: GenericMetadataEntry = Field(None, alias="opcua-websocket")
    ...
    class Config:
        fields = {
            "ksdk_version_warning": {
                ...
                "description": "If outdated, KSDK will warn the user. "
                "If the minimum version is not respected, it will block any operation until upgrade.",
            },
