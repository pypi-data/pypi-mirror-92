...
def studio_start(schema_file: Optional[str], input_file: str) -> bool:
    ...
    """
    from kelvin.sdk.lib.common.apps.launchpad_manager import studio_start as _studio_start

    return _studio_start(schema_file=schema_file, input_file=input_file)
...
def studio_stop() -> bool:
    ...
    """
    from kelvin.sdk.lib.common.apps.launchpad_manager import studio_stop as _studio_stop
