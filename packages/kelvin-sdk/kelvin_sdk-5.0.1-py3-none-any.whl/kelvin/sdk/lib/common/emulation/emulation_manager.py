...
def emulation_start(
    ...
    :param arguments: additional arguments to passed on to the docker image.
    ...
    try:
        ...
        if should_display:
            ...
            display_data_entries(
                ...
                header_names=["Running applications", "Containers", "Up and running", "Ports (container->host)"],
                attributes=["image_name", "container_names", "running", "ports"],
        ...
        logger.exception(f"Error retrieving applications' information: {str(exc)}")
