...
class KSDKLogFormatter(logging.Formatter):
    ...
    def format(self, record: Any) -> str:
        from kelvin.sdk.lib.common.utils.click_utils import COMMAND, COMMAND_PLACEHOLDER

        if COMMAND_PLACEHOLDER in record.msg:
            record.msg = record.msg.replace(COMMAND_PLACEHOLDER, COMMAND)
