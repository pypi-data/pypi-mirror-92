...
def search(query: str) -> List:
    ...
    e.g. {command} appregistry search "my-app"
...
def show(name: str, version: str) -> List:
    ...
    e.g. {command} appregistry show "example-app" --version="1.0.0"
...
def upload(app_dir: str, upload_datamodels: bool = False) -> bool:
    ...
    e.g. {command} appregistry upload --app-dir="."
    """
...
def download(name: str, version: str, local_tag: bool) -> bool:
    ...
    e.g. {command} appregistry download "example-app" "1.0.0"
    """
...
def delete(name: str, version: Optional[str], yes: bool) -> bool:
    ...
    e.g. {command} appregistry delete "example-app" --version="1.0.0"
