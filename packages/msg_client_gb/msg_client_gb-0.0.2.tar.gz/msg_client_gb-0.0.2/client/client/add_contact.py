...
class AddContactDialog(QDialog):
    """
    Диалоговое окно добавления пользователя в список контактов.
    ...
    def possible_contacts_update(self):
        ...
        # Удалим сами себя из списка пользователей, чтобы нельзя
        # было добавить самого себя
    ...
    def update_possible_contacts(self):
        ...
        try:
            ...
            CLI_LOGGER.debug('Обновление списка пользователей '
                             'с сервера выполнено')
            self.possible_contacts_update()
