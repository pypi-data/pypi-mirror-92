...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # Кнопка "Выход"
        self.ui.menu_exit.triggered.connect(qApp.quit)
    ...
    def set_active_user(self):
        ...
        try:
            self.current_chat_key = self.transport.key_request(
                self.current_chat)
            CLI_LOGGER.debug(f'Загружен открытый ключ для {self.current_chat}')
    ...
    def add_contact(self, new_contact):
        ...
        try:
            ...
            CLI_LOGGER.info(f'Успешно добавлен контакт {new_contact}')
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.clients_list_update()
            CLI_LOGGER.info(f'Успешно удалён контакт {selected}')
