...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '3.5.0-alpha.1611079653+709df6e5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 3.5.0-alpha.1611079653+709df6e5`
                """)
            else:
                raise
