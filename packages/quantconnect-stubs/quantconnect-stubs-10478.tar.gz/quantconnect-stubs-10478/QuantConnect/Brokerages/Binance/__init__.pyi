...
class BinanceUtil(System.Object):
    ...
    @staticmethod
    def ConvertOrderStatus(status: str) -> int:
        """
        Convert binance status string value to native Lean OrderStatus
        
        :param status: The Binance order status value
        :returns: Lean order status. This method returns the int value of a member of the QuantConnect.Orders.OrderStatus enum.
        """
        ...
