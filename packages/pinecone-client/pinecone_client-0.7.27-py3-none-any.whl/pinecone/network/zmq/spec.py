...
class ServletSpec:
    ...
    def __init__(self, handle_msg: Optional[Callable[['core_pb2.Request'], Awaitable['core_pb2.Request']]],
                 ...
                 handle_log_msg: Callable[['core_pb2.LogEntry'], Awaitable[Optional['core_pb2.LogEntry']]] = None,
                 log_in_socket: Optional[Socket] = None,
                 log_out_sockets: Optional[List[Socket]] = None):
        """
                :param handle_msg:
                :param in_sockets:
                :param out_sockets:
                :param out_socket_selectors: For each path, a function that takes a Request, and number of out_sockets,
                and returns the Request to send to each socket index
                :param native:
                :param function_name:
                :param replica:
                :param get_stats:
        ...
        self.handle_log_msg = handle_log_msg
        self.log_in_socket = log_in_socket
        self.log_out_sockets = log_out_sockets
