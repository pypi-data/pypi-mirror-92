...
# 
url = 'https://github.com/GoodManWEN/typehints_checker'
...
with open('typehints_checker/__init__.py','r',encoding='utf-8') as f:
...
with open('typehints_checker/__init__.py','w',encoding='utf-8') as f:
    f.writelines(long_description_lines_copy)

setup(
    name="typehints_checker", 
    version=version,
    author="WEN",
