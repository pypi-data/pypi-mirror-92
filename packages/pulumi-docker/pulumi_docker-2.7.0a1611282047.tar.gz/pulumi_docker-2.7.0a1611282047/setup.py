...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.7.0-alpha.1611282047+c69d6acb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.7.0-alpha.1611282047+c69d6acb`
                """)
            else:
                raise
