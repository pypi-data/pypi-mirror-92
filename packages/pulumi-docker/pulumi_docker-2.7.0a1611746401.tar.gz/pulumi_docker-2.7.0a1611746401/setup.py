...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.7.0-alpha.1611746401+ab9a2de0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.7.0-alpha.1611746401+ab9a2de0`
                """)
            else:
                raise
