...
class MongoBase:
    ...
    @staticmethod
    def nap(queue: bool = False, rand: bool = False) -> None:
        time.sleep(MongoBase.get_sleep(queue=queue, rand=rand))

    @staticmethod
    async def anap(queue: bool = False, rand: bool = False) -> None:
        await asyncio.sleep(MongoBase.get_sleep(queue=queue, rand=rand))
