...
def test_pie_chart():
    metadata = {'data': {'transpose': False,
      ...
      'publish': {'embed-width': 600, 'chart-height': 330, 'embed-height': 415},
      'annotate': {'notes': ''},
      'describe': {'intro': '',
       'byline': '',
       'source-url': '',
       ...
       'number-divisor': 0,
       'number-prepend': ''},
      'visualize': {'group': {'text': 'Other', 'num_slices': 5},
       'x-grid': 'off',
       'y-grid': 'on',
       'scale-y': 'linear',
       'labeling': 'right',
       'pie_size': {'inside_labels': 75, 'outside_labels': 50},
       'color_key': {'stack': False,
        'enabled': False,
        'position': 'top',
        'label_values': False},
       'base-color': 0,
       ...
       'small_multiples': {'group_value_label': {'type': 'total',
         'enabled': False,
         'total_text': 'Total',
...
def test_pie_chart2():
    chart_obj = {'width': 380, 'height': 250, 'format': 'png', 'theme': 'newsworthy', 'lang': 'sv', 'overwrite': False, 'chart_engine': 'DatawrapperChart', 'data': [{'key': 'Möjligen boknings- bara', 'value': 0.7186602152835304}, {'key': 'Tillgängliga', 'value': 0.2813397847164696}], 'datatype': None, 'decimals': 0, 'dw_data': {'metadata': {'visualize': {'custom-colors': {'Möjligen boknings- bara': '#cdcdcd', 'Tillgängliga': '#5aa69d'}, 'donut_hole_size': 50, 'inside_labels': {'enabled': False}, 'line-symbols-size': 6.5, 'outside_labels': {'color': False, 'edge': False, 'enabled': True}, 'pie_size': {'inside_labels': 75, 'outside_labels': 50}, 'slice_order': 'original', 'value-label-format': '0%'}}, 'type': 'd3-donuts'}, 'labels': [], 'measures': [], 'periodicity': 'yearly', 'series': [], 'source': None, 'type': 'bars', 'units': 'percent', 'title': None, 'key': '2837248355', 'language': 'sv', 'style': 'newsworthy', 'primary_color': '#5aa69d', 'size': 'normal', 'bar_orientation': 'horizontal', 'show_category_ticks': True, 'ymin': 0, 'ticks': 'yearly', 'highlight_change': False}
    c = DatawrapperChart.init_from(chart_obj, storage=local_storage,
                                   language="sv-SE")
