...
class EmailClient(object):
    ...
    **Note:** Write actions (POST, UPDATE, DELETE) may take several minutes to propagate and be reflected by the API. If a subsequent read request fails to reflect your changes, wait a few minutes and try again.
    ...
    def change_sender_compartment(self, sender_id, change_sender_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/change_sender_compartment.py.html>`__ to see an example of how to use change_sender_compartment API.
        """
    ...
    def create_sender(self, create_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/create_sender.py.html>`__ to see an example of how to use create_sender API.
        """
    ...
    def create_suppression(self, create_suppression_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/create_suppression.py.html>`__ to see an example of how to use create_suppression API.
        """
    ...
    def delete_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/delete_sender.py.html>`__ to see an example of how to use delete_sender API.
        """
    ...
    def delete_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/delete_suppression.py.html>`__ to see an example of how to use delete_suppression API.
        """
    ...
    def get_sender(self, sender_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/get_sender.py.html>`__ to see an example of how to use get_sender API.
        """
        resource_path = "/senders/{senderId}"
        method = "GET"
    ...
    def get_suppression(self, suppression_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/get_suppression.py.html>`__ to see an example of how to use get_suppression API.
        """
        resource_path = "/suppressions/{suppressionId}"
        method = "GET"
    ...
    def list_senders(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/list_senders.py.html>`__ to see an example of how to use list_senders API.
        """
        resource_path = "/senders"
        method = "GET"
    ...
    def list_suppressions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/list_suppressions.py.html>`__ to see an example of how to use list_suppressions API.
        """
        resource_path = "/suppressions"
        method = "GET"
    ...
    def update_sender(self, sender_id, update_sender_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.28.0/email/update_sender.py.html>`__ to see an example of how to use update_sender API.
        """
        resource_path = "/senders/{senderId}"
        method = "PUT"
