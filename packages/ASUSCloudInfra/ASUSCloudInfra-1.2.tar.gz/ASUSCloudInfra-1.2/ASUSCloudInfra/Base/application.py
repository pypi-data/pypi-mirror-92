...
class Service():
    def __init__(self, name:str, image:str, env:Enviroment=None, volumes=None, net:List[Network]=None, cmd:str=None, replicas = 1):
        ...
        with open(path) as file:
            ...
            if 'services' in comp_list:
                ...
                for service in services:
                    ...
                    self._services.append(Service(service['container_name'],service.get('image',None),env, service.get('volumes',None), net, cmd, replicas))          
