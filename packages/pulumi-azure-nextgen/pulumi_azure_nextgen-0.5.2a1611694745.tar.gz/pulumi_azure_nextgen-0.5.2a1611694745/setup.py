...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-nextgen', '0.5.2a1611694745'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-nextgen 0.5.2a1611694745`
                """)
            else:
                raise
