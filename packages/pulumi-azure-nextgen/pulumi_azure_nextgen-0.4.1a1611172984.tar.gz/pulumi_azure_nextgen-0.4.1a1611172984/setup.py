...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-nextgen', '0.4.1a1611172984'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-nextgen 0.4.1a1611172984`
                """)
            else:
                raise
