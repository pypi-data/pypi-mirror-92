...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-nextgen', '0.4.1a1611040903'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-nextgen 0.4.1a1611040903`
                """)
            else:
                raise
