...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-nextgen', '0.5.1a1611653042'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-nextgen 0.5.1a1611653042`
                """)
            else:
                raise
