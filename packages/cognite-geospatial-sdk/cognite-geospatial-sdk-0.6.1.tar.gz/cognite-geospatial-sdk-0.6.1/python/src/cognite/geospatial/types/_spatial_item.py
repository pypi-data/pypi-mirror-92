...
class UpdateSpatialItem:
    ...
    def __eq__(self, other):
        ...
        return (
            self._id == other.id
            and self._external_id == other.external_id
            and self._name == other.name
            and self._description == other.description
            and self._metadata == other.metadata
            and self._asset_ids == other.asset_ids
