...
from convo.shared.constants import LATEST_TRAINING_DATA_FORMAT_VERSION
...
class YAMLStoryWriter(StoryWriter):
    ...
    def process_action(action: ActionExecuted) -> Optional[OrderedDict]:
        ...
        Returns:
            Dict with an action.
        """
        if action.action_name == convo.shared.core.constants.RULE_SNIPPET_ACTION_NAME:
            return None
    ...
    def process_rule_step(self, rule_step: RuleStep) -> OrderedDict:
        ...
        if normal_events and not (
            ...
            == convo.shared.core.constants.RULE_SNIPPET_ACTION_NAME
        ):
