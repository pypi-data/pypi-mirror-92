...
def create_interpreter(
    obj: Union[
        convo.shared.nlu.interpreter.NaturalLanguageInterpreter,
        EndpointConfig,
        Text,
        None,
    ]
    ...
    if isinstance(obj, convo.shared.nlu.interpreter.NaturalLanguageInterpreter):
        return obj
...
class ConvoNLUHttpInterpreter(convo.shared.nlu.interpreter.NaturalLanguageInterpreter):
...
class ConvoNLUInterpreter(convo.shared.nlu.interpreter.NaturalLanguageInterpreter):
    def __init__(
        self,
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        nlu_interpreter_class = convo.shared.utils.common.class_from_module_path(
