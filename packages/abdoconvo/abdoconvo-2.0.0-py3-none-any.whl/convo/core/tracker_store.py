...
from convo.shared.core.events import SessionStarted
...
def _load_from_module_name_in_endpoint_config(
    ...
    try:
        tracker_store_class = convo.shared.utils.common.class_from_module_path(
            store.type
        )
        init_args = convo.shared.utils.common.arguments_of(tracker_store_class.__init__)
