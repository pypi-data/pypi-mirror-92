...
class Simulation(list):
    ...
    def analyze(self,frame,*args,analyze={},**kwargs):

        analysis={}
        for name,func in analyze.items():
    ...
    def make_analysis(self,*args, analyze={}, **kwargs):
        for frame in self:
            frame.make_analysis(*args,analyze=analyze,**kwargs)

        self.frames_analysis=an.objects_analysis(self, *args, analyze=analyze, **kwargs)
