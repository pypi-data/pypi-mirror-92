...
from flask_templates.configs import config_update, BEFORE_CONFIG, template, nacos, before_config_filename
...
class FlaskTemplate:
    ...
    def __init__(self, resource_path='resource', setting={}, *args, **kwargs):
    ...
    @staticmethod
    def fresh_scope(resource_path='resource', setting={}):
