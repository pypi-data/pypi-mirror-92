...
class TrainingDataReader:
    ...
    def read(self, filename: Union[Text, Path], **kwargs: Any) -> "TrainingData":
        ...
        return self.reads(convo.shared.utils.io.read_file(filename), **kwargs)
...
class TrainingDataWriter:
    def dump(self, filename: Text, training_data) -> None:
        ...
        convo.shared.utils.io.write_text_file(s, filename)
    ...
    def generate_list_item(text: Text) -> Text:
        ...
        return f"- {convo.shared.nlu.training_data.util.encode_string(text)}\n"
