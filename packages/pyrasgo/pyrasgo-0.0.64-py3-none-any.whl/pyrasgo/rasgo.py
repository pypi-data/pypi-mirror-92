...
# ------------------
    ...
    def publish_features_from_source(self, data_source_id: int,
        ...
        # TODO: add Database, Schema fields to data model and use those
        db = data_source.table.split(".")[0] if data_source.table.count(".") == 2 else None 
        schema = data_source.table.split(".")[1] if data_source.table.count(".") == 2 else None
        table = data_source.table.split(".")[2] if data_source.table.count(".") == 2 else data_source.table
