...
class UncertaintyTestCase(unittest.TestCase):
    ...
    def test_stat_default(self):
        ...
        self.assertEqual(ax.patches[3]._x1, 110)

        self.assertAlmostEqual(ax.patches[3]._height**2 / 4,
                               0.2**2 + 0.4**2 + 0.1**2)
        self.assertAlmostEqual(ax.patches[3]._y0 + ax.patches[3]._y1, 8.2 * 2)

        self.assertEqual(ax.patches[4]._x0, 110)
        self.assertEqual(ax.patches[4]._x1, 120)
        self.assertAlmostEqual(ax.patches[4]._height**2 / 4,
                               0.3**2 + 0.5**2 + 0.1**2)
        self.assertAlmostEqual(ax.patches[4]._y0 + ax.patches[4]._y1, 10.3 * 2)

        self.assertEqual(ax.patches[5]._x0, 120)
        self.assertEqual(ax.patches[5]._x1, 130)
        self.assertAlmostEqual(ax.patches[5]._height**2 / 4,
                               0.4**2 + 0.4**2 + 0.2**2)
        self.assertAlmostEqual(ax.patches[5]._y0 + ax.patches[5]._y1, 10.4 * 2)

        self.assertEqual(ax.patches[6]._x0, 130)
        self.assertEqual(ax.patches[6]._x1, 140)
        self.assertAlmostEqual(ax.patches[6]._height**2 / 4,
                               0.5**2 + 0.5**2 + 0.2**2)
        self.assertAlmostEqual(ax.patches[6]._y0 + ax.patches[6]._y1, 10.5 * 2)
    ...
    def test_stat_single_si(self):
        ...
        self.assertEqual(ax.patches[1]._x1, 110)
        self.assertAlmostEqual(ax.patches[1]._height**2 / 4,
                               0.2**2 + 0.4**2 + 0.1**2)
        self.assertAlmostEqual(ax.patches[1]._y0 + ax.patches[1]._y1, 8.2 * 2)

        self.assertEqual(ax.patches[2]._x0, 110)
        self.assertEqual(ax.patches[2]._x1, 120)
        self.assertAlmostEqual(ax.patches[2]._height**2 / 4,
                               0.3**2 + 0.5**2 + 0.1**2)
        self.assertAlmostEqual(ax.patches[2]._y0 + ax.patches[2]._y1, 10.3 * 2)

        self.assertEqual(ax.patches[3]._x0, 120)
        self.assertEqual(ax.patches[3]._x1, 130)
        self.assertAlmostEqual(ax.patches[3]._height**2 / 4,
                               0.4**2 + 0.4**2 + 0.2**2)
        self.assertAlmostEqual(ax.patches[3]._y0 + ax.patches[3]._y1, 10.4 * 2)

        self.assertEqual(ax.patches[4]._x0, 130)
        self.assertEqual(ax.patches[4]._x1, 140)
        self.assertAlmostEqual(ax.patches[4]._height**2 / 4,
                               0.5**2 + 0.5**2 + 0.2**2)
        self.assertAlmostEqual(ax.patches[4]._y0 + ax.patches[4]._y1, 10.5 * 2)
    ...
    def test_stat_rebin(self):
        ...
        # Error band
        self.assertEqual(ax.patches[3]._x0, 100)
        self.assertEqual(ax.patches[3]._x1, 120)

        self.assertAlmostEqual(ax.patches[3]._height**2 / 4,
            0.2**2 + 0.3**2 + 0.4**2 + 0.5**2 + 0.1**2 + 0.1**2)
        self.assertAlmostEqual(ax.patches[3]._y0 + ax.patches[3]._y1,
                               18.5 * 2)
        ...
        self.assertAlmostEqual(ax.patches[4]._y0 + ax.patches[4]._y1,
                               20.9 * 2)
    ...
    def test_stat_outside(self):
        ...
        self.assertAlmostEqual(ax.patches[3]._y0 + ax.patches[3]._y1, 14.3 * 2)
        ...
        self.assertAlmostEqual(ax.patches[6]._y0 + ax.patches[6]._y1, 21.1 * 2)
