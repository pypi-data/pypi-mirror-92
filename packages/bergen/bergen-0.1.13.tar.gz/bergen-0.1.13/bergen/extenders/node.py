...
class NodeExtender(BaseExtender):
    ...
    def __call__(self, inputs: dict, template: Template = None, stream=False):
        ...
        try:
            ...
            if event_loop.is_running():
                if stream: return self.__call__as_stream(inputs, template)
                return self.__call_async(inputs, template)
            
        return self.__call_sync(inputs, template)
