...
from pl_data.datasets import LightDataset
from pl_data.utils.imports import _PIL_AVAILABLE
...
class CIFAR10(LightDataset):
    ...
    Examples:
        ...
        >>> from pl_data.datamodules.cifar10_datamodule import cifar10_normalization
