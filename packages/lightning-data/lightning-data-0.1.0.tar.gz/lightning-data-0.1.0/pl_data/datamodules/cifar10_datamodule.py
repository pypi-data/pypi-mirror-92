...
from pl_data.datamodules.vision_datamodule import VisionDataModule
from pl_data.datasets import TrialCIFAR10
from pl_data.utils.imports import _TORCHVISION_AVAILABLE
...
class CIFAR10DataModule(VisionDataModule):
    ...
    Example::
        ...
        from pl_data.datamodules import CIFAR10DataModule
