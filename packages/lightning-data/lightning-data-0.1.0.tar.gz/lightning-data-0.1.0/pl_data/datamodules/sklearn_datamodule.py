...
from pl_data.utils.imports import _SKLEARN_AVAILABLE
from pl_data.utils.warnings import warn_missing_pkg
...
class SklearnDataset(Dataset):
    ...
    Example:
        ...
        >>> from pl_data.datamodules import SklearnDataset
        ...
...
class TensorDataset(Dataset):
    ...
    Example:
        >>> from pl_data.datamodules import TensorDataset
        ...
        >>> X = torch.rand(10, 3)
        >>> y = torch.rand(10)
...
class SklearnDataModule(LightningDataModule):
    ...
    Example:
        ...
        >>> from sklearn.datasets import load_boston
        >>> from pl_data.datamodules import SklearnDataModule
        ...
        >>> X, y = load_boston(return_X_y=True)
...
#     Example:
#
#         >>> from pl_data.datamodules import TensorDataModule
#         >>> import torch
#         ...
#         >>> # create dataset
#         >>> X = torch.rand(100, 3)
