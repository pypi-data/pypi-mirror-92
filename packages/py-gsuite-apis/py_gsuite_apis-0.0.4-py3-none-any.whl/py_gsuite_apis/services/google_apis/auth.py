...
class GoogleAuthCredentialsBase(GoogleAuthCredentials):
    def get_service_account_credentials_path(
        ...
        if not credentials_filename and not credentials_filepath:
            logger.warn(f"Credentials filename: {credentials_filename} - Credentials filepath: {credentials_filepath}")
        ...
        logger.warn(
            ...
            f" - Credentials filepath: {credentials_filepath}"
        )
