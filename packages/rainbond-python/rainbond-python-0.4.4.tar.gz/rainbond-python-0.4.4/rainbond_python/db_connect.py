...
class DBConnect():
    ...
    def find_paging(self, parameter: Parameter) -> tuple:
        parameter.verification(
            ...
            optional={'start_date': None, 'end_date': None})
        ...
        if not records_filtered:
            return '请求数据不存在', 204, [('Content-Type', 'text/plain; charset=utf-8')]
        if sort_list:
