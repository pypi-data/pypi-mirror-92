from collections import Counter, OrderedDict, Mapping, namedtuple
...
# tuple to hold score, text, and bot-name
BotReply = namedtuple('BotReply', ['confidence', 'text', 'skill'], defaults=[None] * 3)  # noqa
