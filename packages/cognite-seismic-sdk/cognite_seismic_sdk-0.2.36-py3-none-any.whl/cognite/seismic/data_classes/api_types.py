...
class VolumeDef:
    ...
    def get_inline_range(self) -> Mapping[int, Tuple[int, int]]:
        """Return the min & max range of traces by inline. That is, the mapping will be from inline numbers to crossline numbers.
    ...
    def get_crossline_range(self) -> Mapping[int, Tuple[int, int]]:
        """Return the min & max range of traces by crossline. That is, the mapping will be from crossline numbers to inline numbers.
