...
常用文件类集合
\n 目前支持方法有：
\n Jenkins_t(Job_num/Svn_list) （Jenkins类处理）
\n File_val(xml_msg/path_val/last_val) （文件类处理，依赖os/xml.dom）
\n Excel(read_data/write_data) （Excel处理，依赖xlrd）
\n @author: 'TangKaiYue'
"""
