...
################################################################################
## Form generated from reading UI file 'newcontract_dialog.ui'
##
...
class Ui_NewContractDialog(object):
    ...
    def retranslateUi(self, NewContractDialog):
        NewContractDialog.setWindowTitle(QCoreApplication.translate("NewContractDialog", u"Dialog", None))
        self.labelDescr.setText(QCoreApplication.translate("NewContractDialog", u"<html><head/><body><p>Details of the <span style=\" font-weight:600;\">new contract</span> between agent #XXX and agent #YYY:</p></body></html>", None))
        self.label.setText(QCoreApplication.translate("NewContractDialog", u"Product name:", None))
        self.label_3.setText(QCoreApplication.translate("NewContractDialog", u"First delivery time:", None))
        self.spinBoxFirstDelivery.setSuffix(QCoreApplication.translate("NewContractDialog", u" sec", None))
        self.label_4.setText(QCoreApplication.translate("NewContractDialog", u"Delivery interval in steps:", None))
    # retranslateUi
