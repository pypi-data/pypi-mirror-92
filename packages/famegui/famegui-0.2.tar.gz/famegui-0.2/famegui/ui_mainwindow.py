...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockProperties.setFeatures(QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        self.dockProperties.setAllowedAreas(Qt.LeftDockWidgetArea|Qt.RightDockWidgetArea)
        self.dockWidgetContents = QWidget()
        self.dockWidgetContents.setObjectName(u"dockWidgetContents")
        self.verticalLayout_3 = QVBoxLayout(self.dockWidgetContents)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.treeProperties = QTreeWidget(self.dockWidgetContents)
        __qtreewidgetitem = QTreeWidgetItem()
        __qtreewidgetitem.setText(0, u"1");
        self.treeProperties.setHeaderItem(__qtreewidgetitem)
        self.treeProperties.setObjectName(u"treeProperties")
        self.treeProperties.setMinimumSize(QSize(300, 200))
        self.treeProperties.setMaximumSize(QSize(16777215, 16777215))

        self.verticalLayout_3.addWidget(self.treeProperties)

        self.dockProperties.setWidget(self.dockWidgetContents)
        MainWindow.addDockWidget(Qt.LeftDockWidgetArea, self.dockProperties)
