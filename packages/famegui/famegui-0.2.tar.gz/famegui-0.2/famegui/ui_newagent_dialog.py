...
################################################################################
## Form generated from reading UI file 'newagent_dialog.ui'
##
...
class Ui_NewAgentDialog(object):
    ...
    def retranslateUi(self, NewAgentDialog):
        NewAgentDialog.setWindowTitle(QCoreApplication.translate("NewAgentDialog", u"Dialog", None))
        self.label.setText(QCoreApplication.translate("NewAgentDialog", u"New agent type :", None))
    # retranslateUi
