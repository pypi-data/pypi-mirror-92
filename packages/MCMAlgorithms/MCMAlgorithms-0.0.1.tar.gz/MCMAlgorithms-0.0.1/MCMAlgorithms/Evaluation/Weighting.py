...
class AHP:
    ...
    def __init__(self):
        self.RI = [0, 0, 0.52, 0.89, 1.12, 1.26, 1.36, 1.41, 1.46, 1.49, 1.52, 1.54, 1.56, 1.58, 1.59, 1.5943,
    ...
    def weighting(self, importance_mtx):
        ...
        :return: ndarray, weight of each factor. For situation where importance matrix does not pass the
...
class Entropy:
    ...
    def weighting(self, data):
        ...
        :param data: ndarray of data matrix
        :return: ndarray, weight of each factor
        """
        # Scaling
