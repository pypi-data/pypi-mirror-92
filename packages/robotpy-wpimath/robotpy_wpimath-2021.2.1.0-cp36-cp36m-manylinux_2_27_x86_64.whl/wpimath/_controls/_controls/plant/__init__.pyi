...
class DCMotor():
    ...
    def Kt(self) -> volt_seconds:
        ...
        """
    @property
    def Kv(self) -> units::unit_t<units::unit<std::ratio<1l, 1l>, units::base_unit<std::ratio<-2l, 1l>, std::ratio<-1l, 1l>, std::ratio<2l, 1l>, std::ratio<1l, 1l>, std::ratio<1l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l> >, std::ratio<0l, 1l>, std::ratio<0l, 1l> >, double, units::linear_scale>:
        """
        :type: units::unit_t<units::unit<std::ratio<1l, 1l>, units::base_unit<std::ratio<-2l, 1l>, std::ratio<-1l, 1l>, std::ratio<2l, 1l>, std::ratio<1l, 1l>, std::ratio<1l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l>, std::ratio<0l, 1l> >, std::ratio<0l, 1l>, std::ratio<0l, 1l> >, double, units::linear_scale>
        """
    @property
    def R(self) -> ohms:
        """
