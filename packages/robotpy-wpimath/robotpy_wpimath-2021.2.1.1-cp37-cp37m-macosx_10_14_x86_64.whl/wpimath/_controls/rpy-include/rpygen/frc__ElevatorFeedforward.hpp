...
struct bind_frc__ElevatorFeedforward {
    ...
    using Acceleration = typename frc::ElevatorFeedforward<Distance>::Acceleration;using kv_unit = typename frc::ElevatorFeedforward<Distance>::kv_unit;using ka_unit = typename frc::ElevatorFeedforward<Distance>::ka_unit;
