...
struct bind_frc__SwerveDrivePoseEstimator {
    ...
    py::class_<typename frc::SwerveDrivePoseEstimator<NumModules>, std::shared_ptr<typename frc::SwerveDrivePoseEstimator<NumModules>>> cls_SwerveDrivePoseEstimator;
