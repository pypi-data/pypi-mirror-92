...
class DCMotor():
    ...
    def Kt(self) -> volt_seconds:
        ...
        """
    @property
    def Kv(self) -> units::unit_t<units::unit<std::ratio<1,1>,units::base_unit<std::ratio<-2,1>,std::ratio<-1,1>,std::ratio<2,1>,std::ratio<1,1>,std::ratio<1,1>,std::ratio<0,1>,std::ratio<0,1>,std::ratio<0,1>,std::ratio<0,1> >,std::ratio<0,1>,std::ratio<0,1> >,double,units::linear_scale>:
        """
        :type: units::unit_t<units::unit<std::ratio<1,1>,units::base_unit<std::ratio<-2,1>,std::ratio<-1,1>,std::ratio<2,1>,std::ratio<1,1>,std::ratio<1,1>,std::ratio<0,1>,std::ratio<0,1>,std::ratio<0,1>,std::ratio<0,1> >,std::ratio<0,1>,std::ratio<0,1> >,double,units::linear_scale>
        """
    @property
    def R(self) -> ohms:
        """
