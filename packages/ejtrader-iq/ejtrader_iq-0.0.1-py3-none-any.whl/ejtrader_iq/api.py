...
from ejtrader_iq.http.login import Login
from ejtrader_iq.http.loginv2 import Loginv2
from ejtrader_iq.http.logout import Logout
from ejtrader_iq.http.getprofile import Getprofile
from ejtrader_iq.http.auth import Auth
from ejtrader_iq.http.token import Token
from ejtrader_iq.http.appinit import Appinit
from ejtrader_iq.http.billing import Billing
from ejtrader_iq.http.buyback import Buyback
from ejtrader_iq.http.changebalance import Changebalance
from ejtrader_iq.http.events import Events
from ejtrader_iq.ws.client import WebsocketClient
from ejtrader_iq.ws.chanels.get_balances import *

from ejtrader_iq.ws.chanels.ssid import Ssid
from ejtrader_iq.ws.chanels.subscribe import *
from ejtrader_iq.ws.chanels.unsubscribe import *
from ejtrader_iq.ws.chanels.setactives import SetActives
from ejtrader_iq.ws.chanels.candles import GetCandles
from ejtrader_iq.ws.chanels.buyv2 import Buyv2
from ejtrader_iq.ws.chanels.buyv3 import *
from ejtrader_iq.ws.chanels.user import *
from ejtrader_iq.ws.chanels.api_game_betinfo import Game_betinfo
from ejtrader_iq.ws.chanels.instruments import Get_instruments
from ejtrader_iq.ws.chanels.get_financial_information import GetFinancialInformation
from ejtrader_iq.ws.chanels.strike_list import Strike_list
from ejtrader_iq.ws.chanels.leaderboard import Leader_Board

from ejtrader_iq.ws.chanels.traders_mood import Traders_mood_subscribe
from ejtrader_iq.ws.chanels.traders_mood import Traders_mood_unsubscribe
from ejtrader_iq.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from ejtrader_iq.ws.chanels.get_order import Get_order
from ejtrader_iq.ws.chanels.get_deferred_orders import GetDeferredOrders
from ejtrader_iq.ws.chanels.get_positions import *
 
from ejtrader_iq.ws.chanels.get_available_leverages import Get_available_leverages
from ejtrader_iq.ws.chanels.cancel_order import Cancel_order
from ejtrader_iq.ws.chanels.close_position import Close_position
from ejtrader_iq.ws.chanels.get_overnight_fee import Get_overnight_fee
from ejtrader_iq.ws.chanels.heartbeat import Heartbeat

 
from ejtrader_iq.ws.chanels.digital_option import *
from ejtrader_iq.ws.chanels.api_game_getoptions import *
from ejtrader_iq.ws.chanels.sell_option import Sell_Option
from ejtrader_iq.ws.chanels.change_tpsl import Change_Tpsl
from ejtrader_iq.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from ejtrader_iq.ws.objects.timesync import TimeSync
from ejtrader_iq.ws.objects.profile import Profile
from ejtrader_iq.ws.objects.candles import Candles
from ejtrader_iq.ws.objects.listinfodata import ListInfoData
from ejtrader_iq.ws.objects.betinfo import Game_betinfo_data
import ejtrader_iq.global_value as global_value
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <ejtrader_iq.http.resource.Resource>`.
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <ejtrader_iq.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <ejtrader_iq.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <ejtrader_iq.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <ejtrader_iq.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <ejtrader_iq.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <ejtrader_iq.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <ejtrader_iq.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <ejtrader_iq.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
    @property
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <ejtrader_iq.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <ejtrader_iq.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <ejtrader_iq.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <ejtrader_iq.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <ejtrader_iq.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
