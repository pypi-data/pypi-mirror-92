...
from my_happy_pandas._typing import Axis, DtypeObj, Scalar
...
from my_happy_pandas.core.internals.managers import (
...
def init_dict(data: Dict, index, columns, dtype: Optional[DtypeObj] = None):
    ...
    if columns is not None:
        from my_happy_pandas.core.series import Series  # noqa:F811
