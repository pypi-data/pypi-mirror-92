...
from my_happy_pandas._typing import FrameOrSeries, FrameOrSeriesUnion
...
from my_happy_pandas.core.aggregation import (
    maybe_mangle_lambdas,
    reconstruct_func,
    validate_func_kwargs,
)
import my_happy_pandas.core.algorithms as algorithms
from my_happy_pandas.core.base import DataError, SpecificationError
...
from my_happy_pandas.core.generic import ABCDataFrame, ABCSeries, NDFrame
from my_happy_pandas.core.groupby import base
from my_happy_pandas.core.groupby.groupby import (
    GroupBy,
    _agg_template,
    _apply_docs,
    _transform_template,
...
from my_happy_pandas.core.indexes.api import Index, MultiIndex, all_indexes_same
import my_happy_pandas.core.indexes.base as ibase
from my_happy_pandas.core.internals import BlockManager, make_block
...
from my_happy_pandas.plotting import boxplot_frame_groupby

if TYPE_CHECKING:
    from my_happy_pandas.core.internals import Block
...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def value_counts(
        ...
        from my_happy_pandas.core.reshape.tile import cut
