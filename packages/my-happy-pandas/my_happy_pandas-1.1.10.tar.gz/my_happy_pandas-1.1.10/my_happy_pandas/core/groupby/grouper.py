...
from my_happy_pandas._typing import FrameOrSeries
...
from my_happy_pandas.core.groupby import ops
from my_happy_pandas.core.groupby.categorical import recode_for_groupby, recode_from_groupby
...
class Grouper:
    ...
    def __new__(cls, *args, **kwargs):
        if kwargs.get("freq") is not None:
            from my_happy_pandas.core.resample import TimeGrouper
