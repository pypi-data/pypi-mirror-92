...
from my_happy_pandas._libs.tslibs import Timestamp

from my_happy_pandas.core.dtypes.common import is_list_like, is_scalar

import my_happy_pandas.core.common as com
from my_happy_pandas.core.computation.common import _ensure_decoded, result_type_many
from my_happy_pandas.core.computation.scope import _DEFAULT_GLOBALS

from my_happy_pandas.io.formats.printing import pprint_thing, pprint_thing_encoded
    ...
    def evaluate(self, env, engine: str, parser, term_type, eval_in_python):
        ...
        if engine == "python":
            ...
            if self.op in eval_in_python:
                ...
                from my_happy_pandas.core.computation.eval import eval
...
class FuncNode:
    def __init__(self, name: str):
        from my_happy_pandas.core.computation.check import _NUMEXPR_INSTALLED, _NUMEXPR_VERSION
