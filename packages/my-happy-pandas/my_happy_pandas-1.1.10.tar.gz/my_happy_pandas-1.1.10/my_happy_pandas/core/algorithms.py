...
from my_happy_pandas._libs import Timestamp, algos, hashtable as htable, iNaT, lib
from my_happy_pandas._typing import AnyArrayLike, ArrayLike, DtypeObj
from my_happy_pandas.util._decorators import doc
...
from my_happy_pandas.core.indexers import validate_indices
...
class SelectNFrame(SelectN):
    ...
    def compute(self, method):
        ...
        from my_happy_pandas import Int64Index
...
def take(arr, indices, axis: int = 0, allow_fill: bool = False, fill_value=None):
    ...
    Examples
    --------
    >>> from my_happy_pandas.api.extensions import take
...
def diff(arr, n: int, axis: int = 0, stacklevel=3):
    ...
    shifted
    """
    from my_happy_pandas.core.arrays import PandasDtype
