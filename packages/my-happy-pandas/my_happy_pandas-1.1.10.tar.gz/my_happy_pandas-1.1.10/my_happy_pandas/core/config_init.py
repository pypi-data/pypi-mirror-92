...
import my_happy_pandas._config.config as cf
...
def use_numexpr_cb(key):
    from my_happy_pandas.core.computation import expressions
...
def use_numba_cb(key):
    from my_happy_pandas.core.util import numba_
...
def table_schema_cb(key):
    from my_happy_pandas.io.formats.printing import _enable_data_resource_formatter
...
def use_inf_as_na_cb(key):
    from my_happy_pandas.core.dtypes.missing import _use_inf_as_na
...
def register_converter_cb(key):
    from my_happy_pandas.plotting import (
