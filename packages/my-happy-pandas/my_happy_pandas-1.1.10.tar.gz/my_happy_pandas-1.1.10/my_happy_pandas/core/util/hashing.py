...
import my_happy_pandas._libs.hashing as hashing
...
def hash_tuples(vals, encoding="utf8", hash_key: str = _default_hash_key):
    ...
    from my_happy_pandas import Categorical, MultiIndex
...
def hash_array(
    ...
    # manage it.
        ...
        if categorize:
            from my_happy_pandas import Categorical, Index, factorize
