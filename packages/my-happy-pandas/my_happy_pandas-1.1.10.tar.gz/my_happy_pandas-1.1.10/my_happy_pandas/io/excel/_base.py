...
from my_happy_pandas.errors import EmptyDataError
from my_happy_pandas.util._decorators import Appender, deprecate_nonkeyword_arguments

from my_happy_pandas.core.dtypes.common import is_bool, is_float, is_integer, is_list_like
...
class ExcelFile:
    ...
    from my_happy_pandas.io.excel._odfreader import _ODFReader
    from my_happy_pandas.io.excel._openpyxl import _OpenpyxlReader
    from my_happy_pandas.io.excel._pyxlsb import _PyxlsbReader
    from my_happy_pandas.io.excel._xlrd import _XlrdReader
