...
from my_happy_pandas._config.config import get_option, set_option

from my_happy_pandas._libs import lib
from my_happy_pandas._libs.missing import NA
from my_happy_pandas._libs.tslib import format_array_from_datetime
from my_happy_pandas._libs.tslibs import NaT, Timedelta, Timestamp, iNaT
from my_happy_pandas._libs.tslibs.nattype import NaTType
from my_happy_pandas._typing import FilePathOrBuffer, Label
...
from my_happy_pandas.core.indexes.api import Index, MultiIndex, PeriodIndex, ensure_index
...
from my_happy_pandas.io.common import stringify_path
from my_happy_pandas.io.formats.printing import adjoin, justify, pprint_thing

if TYPE_CHECKING:
    from my_happy_pandas import Categorical, DataFrame, Series
...
class DataFrameFormatter(TableFormatter):
    ...
    def to_latex(
        ...
        """
        from my_happy_pandas.io.formats.latex import LatexFormatter
    ...
    def to_html(
        ...
        """
        from my_happy_pandas.io.formats.html import HTMLFormatter, NotebookFormatter
    ...
    def _get_formatted_column_labels(self, frame: "DataFrame") -> List[List[str]]:
        from my_happy_pandas.core.indexes.multi import _sparsify
