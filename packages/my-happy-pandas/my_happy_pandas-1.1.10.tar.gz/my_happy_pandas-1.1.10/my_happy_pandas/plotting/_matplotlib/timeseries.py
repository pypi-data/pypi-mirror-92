...
from my_happy_pandas._libs.tslibs import BaseOffset, Period, to_offset
...
from my_happy_pandas.plotting._matplotlib.converter import (
    TimeSeries_DateFormatter,
    TimeSeries_DateLocator,
    TimeSeries_TimedeltaFormatter,
)
from my_happy_pandas.tseries.frequencies import get_period_alias, is_subperiod, is_superperiod

if TYPE_CHECKING:
    from my_happy_pandas import Index, Series  # noqa:F401
    ...
    if data is not None:
        for series, plotf, kwds in data:
            ...
            if isinstance(plotf, str):
                from my_happy_pandas.plotting._matplotlib import PLOT_CLASSES
