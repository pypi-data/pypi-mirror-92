...
from my_happy_pandas._libs.util cimport INT64_MAX, INT64_MIN, UINT64_MAX, is_nan

from my_happy_pandas._libs.tslib import array_to_datetime

from my_happy_pandas._libs.missing cimport (
    C_NA,
    checknull,
    is_null_datetime64,
    is_null_timedelta64,
...
from my_happy_pandas._libs.tslibs.conversion cimport convert_to_tsobject
from my_happy_pandas._libs.tslibs.nattype cimport NPY_NAT, c_NaT as NaT, checknull_with_nat
from my_happy_pandas._libs.tslibs.offsets cimport is_offset_object
from my_happy_pandas._libs.tslibs.period cimport is_period_object
from my_happy_pandas._libs.tslibs.timedeltas cimport convert_to_timedelta64
...
def infer_dtype(value: object, skipna: bool = True) -> str:
    ...
    if util.is_array(value):
        ...
        from my_happy_pandas.core.dtypes.cast import construct_1d_object_array_from_listlike
                ...
                if seen.is_float_or_complex:
                    if seen.complex_:
                        ...
                        if convert_to_nullable_integer:
                            from my_happy_pandas.core.arrays import IntegerArray
