...
from my_happy_pandas._libs.properties import cache_readonly

from my_happy_pandas._libs.tslibs cimport util
...
from my_happy_pandas._libs.tslibs.ccalendar import (
    MONTH_ALIASES,
    MONTH_TO_CAL_NUM,
    int_to_weekday,
    weekday_to_int,
...
from my_happy_pandas._libs.tslibs.ccalendar cimport (
    DAY_NANOS,
    dayofweek,
    get_days_in_month,
    get_firstbday,
...
from my_happy_pandas._libs.tslibs.nattype cimport NPY_NAT, c_NaT as NaT
...
from my_happy_pandas._libs.tslibs.tzconversion cimport tz_convert_from_utc_single
...
cdef class BYearEnd(YearOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BYearEnd
...
cdef class BYearBegin(YearOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BYearBegin
    >>> ts = pd.Timestamp('2020-05-24 05:01:15')
    >>> ts + BYearBegin()
...
cdef class BQuarterEnd(QuarterOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BQuarterEnd
    >>> ts = pd.Timestamp('2020-05-24 05:01:15')
    >>> ts + BQuarterEnd()
...
cdef class BQuarterBegin(QuarterOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BQuarterBegin
    >>> ts = pd.Timestamp('2020-05-24 05:01:15')
    >>> ts + BQuarterBegin()
...
cdef class BusinessMonthEnd(MonthOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BMonthEnd
    >>> ts = pd.Timestamp('2020-05-24 05:01:15')
    >>> ts + BMonthEnd()
    Timestamp('2020-05-29 05:01:15')
    >>> ts + BMonthEnd(2)
...
cdef class BusinessMonthBegin(MonthOffset):
    ...
    Examples
    --------
    >>> from my_happy_pandas.tseries.offset import BMonthBegin
    >>> ts=pd.Timestamp('2020-05-24 05:01:15')
    >>> ts + BMonthBegin()
    Timestamp('2020-06-01 05:01:15')
    >>> ts + BMonthBegin(2)
