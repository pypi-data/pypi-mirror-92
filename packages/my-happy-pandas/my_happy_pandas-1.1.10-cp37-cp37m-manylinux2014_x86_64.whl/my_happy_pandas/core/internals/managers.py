...
from my_happy_pandas._libs import internals as libinternals, lib
from my_happy_pandas._typing import ArrayLike, DtypeObj, Label, Scalar
...
from my_happy_pandas.core.indexers import maybe_convert_indices
from my_happy_pandas.core.indexes.api import Index, ensure_index
from my_happy_pandas.core.internals.blocks import (
    Block,
    CategoricalBlock,
    DatetimeTZBlock,
    ExtensionBlock,
...
from my_happy_pandas.core.internals.ops import operate_blockwise
...
class BlockManager(PandasObject):
    ...
    def quantile(
        ...
        def get_axe(block, qs, axes):
            ...
            #  block.ndim == 2
            from my_happy_pandas import Float64Index
