...
from my_happy_pandas._libs import lib, tslib, tslibs
...
from my_happy_pandas._typing import ArrayLike, Dtype, DtypeObj
...
from my_happy_pandas.core.dtypes.inference import is_list_like
    ...
    if dtype.kind in ["M", "m"] and result.dtype.kind in ["i", "f"]:
        if hasattr(dtype, "tz"):
            ...
            if dtype.tz:
                ...
                from my_happy_pandas import to_datetime
...
def maybe_cast_result_dtype(dtype: DtypeObj, how: str) -> DtypeObj:
    ...
    from my_happy_pandas.core.arrays.integer import Int64Dtype
...
def astype_nansafe(arr, dtype, copy: bool = True, skipna: bool = False):
    ...
    if issubclass(dtype.type, str):
        ...
        # then coerce to a proper dtype and recall astype_nansafe
            ...
            from my_happy_pandas import to_timedelta
...
def soft_convert_objects(
    ...
    if coerce:
        ...
        if datetime:
            ...
            from my_happy_pandas import to_numeric
    ...
    if (convert_string or convert_integer or convert_boolean) and not is_extension:
        ...
        if convert_integer:
            ...
            if is_integer_dtype(input_array.dtype):
                from my_happy_pandas.core.arrays.integer import _dtypes
...
def maybe_infer_to_datetimelike(value, convert_dates: bool = False):
    ...
    def try_datetime(v):
        ...
        try:
            ...
            from my_happy_pandas._libs.tslibs import conversion
