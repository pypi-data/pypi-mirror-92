...
from my_happy_pandas.core.arrays.sparse.array import SparseArray
...
class SparseAccessor(BaseAccessor, PandasDelegate):
    ...
    def from_coo(cls, A, dense_index=False):
        ...
        from my_happy_pandas.core.arrays.sparse.scipy_sparse import _coo_to_sparse_series
    ...
    def to_coo(self, row_levels=(0,), column_levels=(1,), sort_labels=False):
        ...
        [('a', 0), ('a', 1), ('b', 0), ('b', 1)]
        """
        from my_happy_pandas.core.arrays.sparse.scipy_sparse import _sparse_series_to_coo
