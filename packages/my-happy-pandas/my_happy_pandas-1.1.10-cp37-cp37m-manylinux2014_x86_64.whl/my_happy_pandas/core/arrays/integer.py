...
from my_happy_pandas._libs import lib, missing as libmissing
from my_happy_pandas._typing import ArrayLike, DtypeObj
...
from my_happy_pandas.core.dtypes.base import register_extension_dtype
...
from my_happy_pandas.core.ops import invalid_comparison
...
class IntegerArray(BaseMaskedArray):
    ...
    def astype(self, dtype, copy: bool = True) -> ArrayLike:
        ...
        TypeError
            ...
            casting
        """
        from my_happy_pandas.core.arrays.masked import BaseMaskedDtype
    ...
    def _create_comparison_method(cls, op):
        ...
        def cmp_method(self, other):
            from my_happy_pandas.arrays import BooleanArray
