...
from my_happy_pandas._typing import AnyArrayLike, ArrayLike, Dtype, DtypeObj

from my_happy_pandas.core.dtypes.base import ExtensionDtype, registry
...
if TYPE_CHECKING:
    ...
    from my_happy_pandas.core.indexes.api import Index  # noqa: F401
