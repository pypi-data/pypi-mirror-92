...
class APIRequestor(object):
    ...
    def request(self, method, url, headers=None, body=None, params=None, api_key=None):
        ...
        return self.request_base(method=method, url=abs_url, headers=headers, body=body, params=params, api_key=token)

    def request_base(self, method, url, headers=None, body=None, params=None, api_key=None):
