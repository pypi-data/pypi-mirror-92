...
def make_updated_fpd_file(src, dst, func, func_kwargs=None,
    ...
    progress_bar : bool
        If True, progress bars are printed.
    reopen_file : bool
        If True, the source file is closed and reopened before copying. See Notes.
...
See https://gitlab.com/fpdpy/fpd/-/issues/38 for details.'''
    ...
    with h5py.File(dst, 'w') as new_file:
        ...
        ## could use more nuanced approach to avoid copying main dataset
        #h5f.visititems
        #h5f.copy
        #new_file.create_dataset_like
