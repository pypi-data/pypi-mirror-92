...
def makeaxis(ax1,axy2,axx2,objects,cats,mindiff,
    ...
    yvalss = None
    if axy2 != None:
        minsy,maxsy,ylocss,yvalss,secondytrans = makeaxis_sub(axy2,'sy',objects,second_ylabel,second_yticks,second_ysubticks,second_yrotation,second_yalign,second_yminmax,second_yzero,second_yfontsize,second_ylog,second_ybase,second_ylog0)
    ...
    xvalss = None
    if axx2 != None:
        minsx,maxsx,xlocss,xvalss,secondxtrans = makeaxis_sub(axx2,'sx',objects,second_xlabel,second_xticks,second_xsubticks,second_xrotation,second_xalign,second_xminmax,second_xzero,second_xfontsize,second_xlog,second_xbase,second_xlog0)
...
def display(rawobjects,fname,write = False,fontsize = FONTSIZE,figsize = (8,6),frame = True,ext = 'png',lloc = (0.5,-0.1),lpos = 'upper center',
            ...
            second_xbase=10,second_xlog0 = None,save = True):
