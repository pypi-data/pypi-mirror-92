...
[boto3.ElasticInference 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/elastic-inference.html#ElasticInference) service
compatible with
