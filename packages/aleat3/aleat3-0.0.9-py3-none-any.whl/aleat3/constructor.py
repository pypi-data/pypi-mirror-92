...
def coinToBinary(res):
    if res.strip().lower() == "head":
        ...
        _color.output_red("ERROR: You must enter an aleatory.dice string output for binary conversion")
        return None
...
def coinToBool(res):
    ...
    if e == 1:
        ...
        _color.output_red("ERROR: You must enter an aleatory.dice string output for boolean conversion")
