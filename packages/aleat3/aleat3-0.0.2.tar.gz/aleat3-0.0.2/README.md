...
## What's new in aleat3 0.0.2

Now, you can change the Aleatoryous mode after you changed it, introducing the new
mode:
...
But if you change it to a *aleatory.roulette*:

```python
obj.mode = "Roulette"

obj.dict = {1: "Option 1", 2: "Option 2",}
# You must enter a dictionary with shorter key 1 and without repetitions
```
