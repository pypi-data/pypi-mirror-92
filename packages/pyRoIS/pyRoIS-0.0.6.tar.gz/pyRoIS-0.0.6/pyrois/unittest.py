...
from . import Service_Application_IF, Service_Application_Base_sample
from . import HRI_Engine_client, HRI_Engine_sample
...
class TestServericeApplicationIF(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ps = Process(target=sample_sa, args=(8000,))
        self.ps.start()
    ...
    def test_IF(self):
        ...
        pc = Process(target=sample_sa_IF, args=("http://127.0.0.1:8000/", q))
        pc.start()
...
class TestPD(unittest.TestCase):
    ...
    def setUp(self):
        # start the server process
        self.ps = Process(target=sample_pd, args=(8003,))
        self.ps.start()
