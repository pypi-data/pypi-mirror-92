...
@click.option("--has_resource_roles", type=bool, default=None)
...
@click.option("--admin_state", default=None)
...
@click.option("--domain_aliases", default=None, multiple=True)
@click.option(
...
@click.option("--connection_uri", default=None)
@click.option("--max_number_connections", type=int, default=None)
@click.option("--service_account_required", default=True, is_flag=True)
@click.pass_context
...
@click.option("--service_account_required/--service_account_not_required", default=True)
@click.pass_context
...
@click.option("--org_id", default=None)
@click.option("--user_id", default=None)
@click.option("--resource_role_name", default=None)
@click.option("--resource_id", default=None)
@click.option("--resource_type", default="fileshare")
@click.option("--limit", default=500)
@click.pass_context
...
@click.argument("resource_role_name")
