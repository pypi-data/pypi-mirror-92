...
[boto3.ApplicationAutoScaling 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
compatible with
