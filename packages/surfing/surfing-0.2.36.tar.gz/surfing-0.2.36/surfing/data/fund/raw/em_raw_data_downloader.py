...
class EmRawDataDownloader:
    ...
    def em_fund_ipo_stats_history(self, csv_path):
    ...
    def em_stock_fs_balance_sheet_from_excel(self):
            # 全部A股股票
            stock_list = self._em_sector_wrapper('001004', end_date)
            if stock_list is None:
...
if __name__ == '__main__':
    ...
    # em.em_conv_bond_clean_price('20090301', '20091231')
    # em.em_conv_bond_dirty_price('20090301', '20091231')
