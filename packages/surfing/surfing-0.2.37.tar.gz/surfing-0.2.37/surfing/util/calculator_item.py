...
class CalculatorBase:
    ...
    def calc_recent_ret(dates:             pd.core.series.Series,
                        ...
                        frequency:         str='1D'):
        assert frequency in ['1D'], 'frequency provided is not included, must in 1D 1W 2W 1M'
        ...
        recent_natural_year_ret = sr.loc[:last_date][-1] / sr.loc[:_natural_year_begin_date][-1] - 1
    ...
    def get_stat_result(dates:             pd.core.series.Series,
        ...
        if len(dates) > 2:
            ...
            _begin_date = sr.index[0]
            recent_ret_res = CalculatorBase.calc_recent_ret(dates=dates,values=values,frequency=frequency)
