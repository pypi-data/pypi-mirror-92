...
class RustBackendGenerated:
    ...
    def filter_to_search(self, input: pb.FilterToSearchIn) -> str:
        output = pb.String()
    ...
    def concatenate_searches(self, *, sep: pb.ConcatenateSearchesIn.SeparatorValue, searches: Sequence[str]) -> str:
    ...
    def sync_server_method(self, *, method: pb.SyncServerMethodIn.MethodValue, data: bytes) -> bytes:
    ...
    def all_tags(self) -> Sequence[pb.Tag]:
        input = pb.Empty()
        output = pb.AllTagsOut()
        output.ParseFromString(self._run_command(97, input))
        return output.tags

    def set_tag_collapsed(self, *, name: str, collapsed: bool) -> pb.Empty:
