...
from azureml.automl.core.shared.exceptions import UserException, ValidationException, ClientException
...
from azureml.train.automl import _azureautomlclient, _azureautomlsettings, _logging
...
def prepare_managed_inputs(experiment, local_path, settings_obj, data_params, run_config):
    ...
    automl_estimator = _azureautomlclient.AzureAutoMLClient(experiment_state)

    parent_run = automl_estimator._create_parent_run_for_local_managed(data_params)
