...
class IDrone(IRobot, abc.ABC):
    ...
    def _get_device(self, key, name):
        device_retriever = {
            EnableableDevice.RECEIVER: self.getDevice,
            EnableableDevice.CAMERA: self.getDevice,
            EnableableDevice.INERTIAL_UNIT: self.getDevice,
            EnableableDevice.GPS: self.getDevice,
            EnableableDevice.COMPASS: self.getDevice,
            EnableableDevice.GYRO: self.getDevice,
            MotorDevice.CAMERA: self.getDevice,
            MotorDevice.PROPELLER: self.getDevice,
            NonEnableableDevice.LED: self.getDevice,
            NonEnableableDevice.EMITTER: self.getDevice,
        }
