...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to edit", init=True)
@option(
    "visibility",
    char="v",
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, init=True)
@option(
    "description",
    char="d",
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to add the user", init=True)
@user_id_options()
@option(
    "permission-new",
    char="p",
...
@id_identifier_options(
    class_type=CLICollection, helptext="to remove the user", init=True
)
@user_id_options()
...
@apy_command
@id_identifier_options(
    class_type=CLICollection, helptext="to remove the group", init=True
)
@id_identifier_options(class_type=Group, init=True)
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to delete", init=True)
@option(
...
@apy_command
@id_identifier_options(
    class_type=CLICollection, helptext="to link to the record", init=True
)
@id_identifier_options(
    class_type=Record, helptext="to link to the collection", init=True
)
...
@apy_command
@id_identifier_options(
    class_type=CLICollection, helptext="to remove the record", init=True
)
@id_identifier_options(
    class_type=Record, helptext="to remove from the collection", init=True
)
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to add a tag", init=True)
...
@collections.command()
@apy_command
@id_identifier_options(class_type=CLICollection, helptext="to remove a tag", init=True)
