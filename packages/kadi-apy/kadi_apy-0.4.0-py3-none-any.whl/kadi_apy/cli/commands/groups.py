...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to edit", init=True)
@option(
    "visibility",
    char="v",
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, init=True)
@option(
    "description",
    char="d",
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to add the user", init=True)
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to remove the user", init=True)
...
@groups.command()
@apy_command
@id_identifier_options(class_type=CLIGroup, helptext="to delete", init=True)
