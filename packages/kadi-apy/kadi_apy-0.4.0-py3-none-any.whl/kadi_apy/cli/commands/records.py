...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to edit", init=True)
@option(
    "visibility",
    char="v",
    description="Visibility of the record",
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, init=True)
...
@id_identifier_options(
    class_type=CLIRecord, helptext="to add the group with role permissions", init=True
)
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to delete", init=True)
@option(
...
@records.command()
@apy_command
@id_identifier_options(class_type=CLIRecord, helptext="to add a metadatum", init=True)
...
@apy_command
@id_identifier_options(
    class_type=CLIRecord, helptext="to delete a metadatum", init=True
)
...
@apy_command
@id_identifier_options(
    class_type=CLIRecord, helptext="to delete all metadata", init=True
)
@option(
    "i-am-sure",
...
@apy_command
@id_identifier_options(
    class_type=CLIRecord, helptext="to download files from", init=True
)
...
@id_identifier_options(class_type=CLIRecord, init=True)
@id_identifier_options(
    class_type=Record, init=True, name="link", helptext="to be linked"
)
