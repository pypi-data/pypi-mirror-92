...
class TableManager(HtmlDescriptionProvider):
    ...
    def getHtmlDescription(self):
        ...
        methods = [htmlHelpers.code(method) for method in methods]

        return f'tableManager\'s methods: <ul><li>' + '</li><li>'.join(methods) + '</li></ul>'
