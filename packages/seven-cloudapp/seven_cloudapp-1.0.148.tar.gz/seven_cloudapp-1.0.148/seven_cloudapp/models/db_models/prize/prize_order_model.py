...
class PrizeOrder:
    ...
    def __init__(self):
        ...
        self.order_status = 0  # 状态（0未发货1已发货2不予发货3订单同步失败）
        self.remarks = ""  # 备注
        self.error_desc = ""  # 订单同步失败原因
        self.create_date = "1900-01-01 00:00:00"  # 创建时间
        self.modify_date = "1900-01-01 00:00:00"  # 修改时间

    @classmethod
    def get_field_list(self):
        return ['id', 'order_no', 'app_id', 'act_id', 'open_id', 'owner_open_id', 'user_nick', 'real_name', 'telephone', 'province', 'city', 'county', 'street', 'adress', 'deliver_date', 'express_no', 'express_company', 'order_status', 'remarks', 'error_desc', 'create_date', 'modify_date']
