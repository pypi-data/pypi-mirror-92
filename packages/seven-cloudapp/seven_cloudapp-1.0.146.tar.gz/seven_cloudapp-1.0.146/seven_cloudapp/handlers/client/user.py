...
:LastEditTime: 2021-01-21 16:50:08
...
from models.db_models.user.user_base_model import *
...
class UserBaseHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        page_count = self.get_page_count(page_size, record_count)
...
class UserHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        try:
            ...
            act_id = int(self.get_param("act_id", 0))
            open_id = "AAEuuTVMAM0w5byF5_KVHVNl"
