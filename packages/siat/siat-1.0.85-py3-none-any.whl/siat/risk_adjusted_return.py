...
def get_prices_yahoo(ticker,fromdate,todate):
    ...
    **Adjusted close price adjusted for both dividends and splits. 
    ...
    if result is None:
        print("#Error(get_prices_yahoo): invalid date period",fromdate,todate)        
        return None         
    ...
    try:
        ...
        print("  1)unstable internet connection.")
...
def get_prices_yf(ticker,start,end):
    ...
    if r is None:
        print("Error #1(get_prices_yf): invalid time period",start,end)
        return None        
