...
class getDiffResultsHash_args(object):
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter267 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter268 in self.skipDetectionStatuses:
...
class getRunReportCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter303 in self.runIds:
                oprot.writeI64(iter303)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i352 in range(_size348):
                        _elem353 = LinesInFilesRequested()
                        _elem353.read(iprot)
                        self.linesInFilesRequested.append(_elem353)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter354 in self.linesInFilesRequested:
                iter354.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter369, viter370 in self.success.items():
                oprot.writeI64(kiter369)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter370))
                for kiter371, viter372 in viter370.items():
                    oprot.writeI64(kiter371)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter472, viter473 in self.success.items():
                oprot.writeString(kiter472.encode('utf-8') if sys.version_info[0] == 2 else kiter472)
                oprot.writeI64(viter473)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getAnalyzerNameCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i513 in range(_size509):
                        _key514 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val515 = iprot.readI64()
                        self.success[_key514] = _val515
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.success))
            for kiter516, viter517 in self.success.items():
                oprot.writeString(kiter516.encode('utf-8') if sys.version_info[0] == 2 else kiter516)
                oprot.writeI64(viter517)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i522 in range(_size518):
                        ...
                        self.sourceComponentFilter.append(_elem523)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter524 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i536 in range(_size532):
                        ...
                        self.fileHashes.append(_elem537)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter538 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i550 in range(_size546):
                        ...
                        self.trimPathPrefixes.append(_elem551)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter552 in self.trimPathPrefixes:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i557 in range(_size553):
                        _key558 = iprot.readI32()
                        _val559 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter560, viter561 in self.success.items():
                oprot.writeI32(kiter560)
                oprot.writeI64(viter561)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i566 in range(_size562):
                        _key567 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val568 = AnalyzerStatistics()
                        _val568.read(iprot)
                        self.success[_key567] = _val568
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
