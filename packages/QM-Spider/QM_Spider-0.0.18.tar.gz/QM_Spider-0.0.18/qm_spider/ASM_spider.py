...
class Get_ASM_Consume:
    def __init__(self, accountName, accountPwd, X_Apple_Widget_Key='a01459d797984726ee0914a7097e53fad42b70e1f08d09294d14523a1d4f61e1', file_name='ASM-可用余额存取表.csv', file_path='./'):
                        ...
                        if budget_name[:7] != '1317320':
                            ...
                            if int(spent_value) != 0:
                                ...
                                if now_yue_days <= 7:  # 小于等于7则推送，否则不管；
                                    ...
                                    DingDing_Push(push_title, *[push_text])
                                    # 推送成功，进行下一步；
                            else:
                                pass
