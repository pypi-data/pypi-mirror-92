...
class DecoratorMetaclass(type):
    ...
    def __new__(cls, name, bases, attrs):
        ...
        def decorateInit(decorator, *args, **kwargs):
            if args and isinstance(args[0], FunctionType) and args[0].__name__ not in calledFunctions:
