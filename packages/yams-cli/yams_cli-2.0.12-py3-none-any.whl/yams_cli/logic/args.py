...
def setup_yams_object(command):
    ...
    commands['list'].add_argument('-star-date', action='store_true',
                                  help="Epoch in seconds timestamp of the starting date to list objects or Date in UTC 2021-01-27, 2021-01-27T10:00:00")
    commands['list'].add_argument('--end-date', action='store_true',
                                  help="Epoch in seconds timestamp of the ending date to list objects or Date in UTC 2021-01-27, 2021-01-27T10:00:00")
