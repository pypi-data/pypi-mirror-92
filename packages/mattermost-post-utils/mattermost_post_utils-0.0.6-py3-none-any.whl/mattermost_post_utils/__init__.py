...
def send_rss_to_mattermost(url_webhook, title, title_link, users_mentioned, thread, content):
    """
    ...
    field_users_mentioned = Field(False, users_mentioned, thread)

    fields = [field_users_mentioned]
