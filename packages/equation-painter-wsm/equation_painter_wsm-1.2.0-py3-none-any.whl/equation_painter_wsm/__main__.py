...
try:
	os.mkdir(os.path.expanduser("~"+os.sep+'Desktop'+os.sep+'Equation Painter'))
except FileExistsError:
	pass
name = '{}.xlsx'.format(input('Give a name to your spreadsheet!\n> '))
print("Your spreadsheet will be named",name+".","And saved on your Desktop in a folder called Equation Painter.")
workbook = xlsxwriter.Workbook(os.path.expanduser("~"+os.sep+'Desktop'+os.sep)+'Equation Painter'+os.sep+name)
...
while True:
	try:
		siz = abs(int(input('What should the sixe of the image be in pixels? (78 default)\n> ')))
		break
	except:
		print('Please provide a number!')
...
result = img.resize((siz,siz),resample=Image.BILINEAR)
