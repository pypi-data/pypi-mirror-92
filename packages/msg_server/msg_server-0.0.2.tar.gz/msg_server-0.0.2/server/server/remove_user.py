...
class DelUserDialog(QDialog):
    ...
    def remove_user(self):
        ...
        if self.selector.currentText() in self.server.users_dict:
            sock = self.server.users_dict[self.selector.currentText()]
            del self.server.users_dict[self.selector.currentText()]
