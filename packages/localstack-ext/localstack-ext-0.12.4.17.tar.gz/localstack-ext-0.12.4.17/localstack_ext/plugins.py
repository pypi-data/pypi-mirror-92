...
def register_localstack_plugins():
 ...
 if mOIad([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in mOIaS(e):
   print(e)
...
def api_key_configured():
 return mOIak(os.environ.get('LOCALSTACK_API_KEY'))
