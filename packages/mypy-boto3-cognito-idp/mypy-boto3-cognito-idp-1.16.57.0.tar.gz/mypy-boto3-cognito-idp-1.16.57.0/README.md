...
[boto3.CognitoIdentityProvider 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
