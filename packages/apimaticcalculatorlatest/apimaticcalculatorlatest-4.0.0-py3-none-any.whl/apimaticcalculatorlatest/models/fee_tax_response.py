...
class FeeTaxResponse(object):

    """Implementation of the 'FeeTaxResponse' model.
    ...
    Attributes:
        ...
        data (list of FeeTax): List of models
    ...
    def __init__(self,
                 ...
                 code=None,
                 data=None):
        """Constructor for the FeeTaxResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(apimaticcalculatorlatest.models.fee_tax.FeeTax.from_dictionary(structure))
