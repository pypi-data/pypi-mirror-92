...
import apimaticcalculatorlatest.models.p_ms

class GetPMslist(object):

    """Implementation of the 'GetPMslist' model.
    ...
    Attributes:
        ...
        data (list of PMs): List of PMs models
    ...
    def __init__(self,
                 ...
                 code=None,
                 data=None):
        """Constructor for the GetPMslist class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(apimaticcalculatorlatest.models.p_ms.PMs.from_dictionary(structure))
