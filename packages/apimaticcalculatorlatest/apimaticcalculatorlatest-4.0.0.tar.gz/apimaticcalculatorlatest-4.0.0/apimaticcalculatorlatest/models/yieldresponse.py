...
class Yieldresponse(object):
    ...
    """Implementation of the 'Yieldresponse' model.
    ...
    Attributes:
        ...
        data (list of TransportYield): List of Models
    ...
    def __init__(self,
                 ...
                 code=None,
                 data=None):
        """Constructor for the Yieldresponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(apimaticcalculatorlatest.models.transport_yield.TransportYield.from_dictionary(structure))
