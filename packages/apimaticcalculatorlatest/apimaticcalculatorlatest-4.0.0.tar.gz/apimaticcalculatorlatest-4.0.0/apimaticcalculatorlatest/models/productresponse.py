...
class Productresponse(object):
    ...
    """Implementation of the 'Productresponse' model.
    ...
    Attributes:
        ...
        data (list of Property): List of models
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(apimaticcalculatorlatest.models.property.Property.from_dictionary(structure))
