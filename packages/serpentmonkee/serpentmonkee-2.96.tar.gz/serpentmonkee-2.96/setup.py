...
setup(
    ...
    version='2.96',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/anthromorphic-ai/serpentmonkee/archive/2.96.tar.gz',
