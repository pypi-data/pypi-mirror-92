...
if __name__ == '__main__':
    ...
    neomnkee = NeoMonkee(neoDriver=None,
                         sqlClient=sqldb,
                         callingCF="testingCF")
    ...
    def test_readWrite():
        ...
        res = neomnkee.readResults(query=query,
                                   params=params,
                                   cfInstanceUid='1234')
        ...
        res = neomnkee.writeResults(query=query,
                                    params=params,
                                    cfInstanceUid='1234')
        ...
        params = {'projectname': 'Sandbox'}
        res = neomnkee.writeResultsBatch(query=query,
                                         params=params,
                                         batch=batch,
                                         cfInstanceUid='1234')
    ...
    w = CypherTransactionBlockWorker(neoMonkee=neomnkee, cypherQueues=cqs)
