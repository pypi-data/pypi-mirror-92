...
from dantic.core import is_iterable_of_models, make_json_response
from dantic.exceptions import InvalidIterableOfModelsException


def validate(self, query=None, data=None, resp=None, x=[], tags=[],
             exclude_none: bool = False, response_by_alias: bool = False):
