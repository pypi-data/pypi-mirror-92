...
from libopy._wallet import DEFAULT_BECH32_HRP, privkey_to_address, privkey_to_pubkey
from libopy.typing import SyncMode
...
class Transaction:
    ...
    def add_transfer(self, recipient: str, amount: int, denom: str = "flby") -> None:
        transfer = {
