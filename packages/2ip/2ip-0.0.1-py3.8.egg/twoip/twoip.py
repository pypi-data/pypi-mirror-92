...
class TwoIP(object):
    ...
    def __init__(self, key: Optional[str] = None) -> object:
        ...
        for endpoint in self.endpoints:
            for type in self.endpoints[endpoint]:
                self.__cache[type] = {}
                for format in self.endpoints[endpoint]['format']:
                    self.__cache[endpoint][format] = {}
    ...
    def geo(self, ip: str, force: bool = False, cache: bool = True) -> Union[dict, str]:
    ...
    def provider(self, ip: str, format: str = 'json', force: bool = False, cache: bool = True) -> Union[dict, str]:
        ...
        ------
        ValueError
            Invalid IP address or invalid output type requested
