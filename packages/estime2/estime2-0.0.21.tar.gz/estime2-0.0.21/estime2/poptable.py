...
def calculate_absorbable_in_other_comp(
    ...
    for k2, other_tbl in other_tbls.items():
        ...
        df_peal_ca = None
        if other_comp_in_comp_end:
            df_peal_ca = otbl_pop_end\
        ...
        if other_comp_in_neg:
            ...
            # 99999999 is the "+Infinity" of this function.
            to_append = np.repeat([99999999], len(other_comp_values_ca))
        ...
        if isinstance(to_modify_age, int):
            ...
            if other_comp_in_neg:
                # Here lies the maximum value to INCREASE in other_comp
