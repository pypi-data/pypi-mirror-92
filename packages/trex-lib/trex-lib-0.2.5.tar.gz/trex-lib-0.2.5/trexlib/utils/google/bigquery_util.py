...
def create_table_from_template(dataset_name, table_name, table_scheme, table_name_surfix=None, 
                               partition_value=None, bigquery_client=None):
...
def stream_data_by_datetime_partition(bigquery_client, dataset_name, table_template_name, data_dict_to_stream, column_name_used_to_partition=None, 
    ...
    for table_name_suffix, data_list_to_stream in data_dict_to_stream.items():
        ...
        for partition_value_str, partition_list in partition_dict.items():
            ...
            created_table   = create_table_from_template(dataset_name, table_template_name, 
