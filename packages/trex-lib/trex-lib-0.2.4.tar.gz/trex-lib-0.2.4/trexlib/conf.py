...
TASK_SERVICE_ACCOUNT_KEY_FILEPATH                   = os.environ['TASK_SERVICE_ACCOUNT_KEY']
TASK_SERVICE_CREDENTIAL_PATH                        = os.path.abspath(os.path.dirname(__file__)) + '/../' + TASK_SERVICE_ACCOUNT_KEY_FILEPATH
...
BIGQUERY_SERVICE_CREDENTIAL_PATH                    = os.path.abspath(os.path.dirname(__file__)) + '/../' + BIGQUERY_SERVICE_ACCOUNT_KEY_FILEPATH
