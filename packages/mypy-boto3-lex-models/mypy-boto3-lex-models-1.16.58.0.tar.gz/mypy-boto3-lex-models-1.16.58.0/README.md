...
[boto3.LexModelBuildingService 1.16.58](https://boto3.amazonaws.com/v1/documentation/api/1.16.58/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
