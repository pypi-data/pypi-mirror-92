...
class DatasetsAPI():
    ...
    def store(self, dataset_name:str, dataset_path:str) -> str:
        ...
        try:
            shutil.make_archive(dataset_name, 'gztar', root_dir=base_path, base_dir=directory_name)
            os.chdir(old_dir)
            ...
            for name, extension, _ in shutil.get_unpack_formats():
                try:
                    shutil.make_archive(dataset_name, name, root_dir=base_path, base_dir=directory_name)
                    os.chdir(old_dir)
