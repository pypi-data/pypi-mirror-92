...
# from articleparser.blockmaker import Block, Blockmaker
...
class Article(object):
    ...
    block_list : list[dict] 
        The list of blocks of the cleaned `bs4.BeautifulSoup` object.
    ...
    def parse(self) -> None:
        ...
        # self.backup_soup = copy.deepcopy(self.soup)
