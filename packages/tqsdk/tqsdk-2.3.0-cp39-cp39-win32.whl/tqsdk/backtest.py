...
# from datetime import date, datetime
# from tqsdk import TqApi, TqAuth, TqBacktest, TargetPosTask, diff
#
# # 在创建 api 实例时传入 TqBacktest 就会进入回测模式
# api = TqApi(backtest=TqBacktest(start_dt=date(2019, 3, 1), end_dt=date(2019, 3, 10)), auth=TqAuth("myanq@qq.com", "123456a"))
#
# klines = api.get_kline_serial(["CFFEX.IF1906", "SHFE.au1906"], 5*60, data_length=15)
# klines1 = api.get_kline_serial(["SHFE.au1906"], 5*60, data_length=15)
# klines2 = api.get_kline_serial(["CFFEX.IF1906"], 5*60, data_length=15)
# while True:
#     api.wait_update()
