...
def test_edit_doc():
    ...
    runner.invoke(cli, ["edit-doc", "-k", "key1"])
    click.edit = Mock(return_value='{"key2": {"key21": "val21"}}')
    runner.invoke(cli, ["edit-doc", "-k", "key2"])
    click.edit = Mock(return_value='{"key3": ["val31", "val32"]}')
    runner.invoke(cli, ["edit-doc", "-k", "key3"])
...
def test_delete_doc():
    ...
    runner.invoke(cli, ["del-doc", "-k", "some_key"])
