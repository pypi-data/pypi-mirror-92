...
# This option only applies to the Hermes Lite 2.
# This controls the Icom AH-4 compatible ATU attached to the Hermes Lite 2 end plate. Set it to None if you don't
# have an automatic tuner.
# Set it to Tune to send a tune request when the Quisk Spot button is pressed.
# Changes are immediate (no need to restart).
