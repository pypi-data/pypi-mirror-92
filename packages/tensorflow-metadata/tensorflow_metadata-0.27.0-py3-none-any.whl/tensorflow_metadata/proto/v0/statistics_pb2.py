...
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_STRINGTOKENS = _descriptor.Descriptor(
  name='StringTokens',
  full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.StringTokens',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tokens', full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.StringTokens.tokens', index=0,
...
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_INTTOKENS = _descriptor.Descriptor(
  name='IntTokens',
  full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.IntTokens',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tokens', full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.IntTokens.tokens', index=0,
...
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES = _descriptor.Descriptor(
  name='ReportedSequences',
  full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='string_tokens', full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.string_tokens', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int_tokens', full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.int_tokens', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_STRINGTOKENS, _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_INTTOKENS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='tokens', full_name='tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.tokens',
      index=0, containing_type=None, fields=[]),
  ],
...
_NATURALLANGUAGESTATISTICS = _descriptor.Descriptor(
  ...
  nested_types=[_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES, _NATURALLANGUAGESTATISTICS_TOKENSTATISTICS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_STRINGTOKENS.containing_type = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_INTTOKENS.containing_type = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['string_tokens'].message_type = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_STRINGTOKENS
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['int_tokens'].message_type = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_INTTOKENS
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.containing_type = _NATURALLANGUAGESTATISTICS
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.oneofs_by_name['tokens'].fields.append(
  _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['string_tokens'])
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['string_tokens'].containing_oneof = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.oneofs_by_name['tokens']
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.oneofs_by_name['tokens'].fields.append(
  _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['int_tokens'])
_NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.fields_by_name['int_tokens'].containing_oneof = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES.oneofs_by_name['tokens']
...
_NATURALLANGUAGESTATISTICS.fields_by_name['reported_sequences'].message_type = _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES
...
NaturalLanguageStatistics = _reflection.GeneratedProtocolMessageType('NaturalLanguageStatistics', (_message.Message,), {
  ...
  'ReportedSequences' : _reflection.GeneratedProtocolMessageType('ReportedSequences', (_message.Message,), {

    'StringTokens' : _reflection.GeneratedProtocolMessageType('StringTokens', (_message.Message,), {
      'DESCRIPTOR' : _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_STRINGTOKENS,
      '__module__' : 'tensorflow_metadata.proto.v0.statistics_pb2'
      # @@protoc_insertion_point(class_scope:tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.StringTokens)
      })
    ,

    'IntTokens' : _reflection.GeneratedProtocolMessageType('IntTokens', (_message.Message,), {
      'DESCRIPTOR' : _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES_INTTOKENS,
      '__module__' : 'tensorflow_metadata.proto.v0.statistics_pb2'
      # @@protoc_insertion_point(class_scope:tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences.IntTokens)
      })
    ,
    'DESCRIPTOR' : _NATURALLANGUAGESTATISTICS_REPORTEDSEQUENCES,
    '__module__' : 'tensorflow_metadata.proto.v0.statistics_pb2'
    # @@protoc_insertion_point(class_scope:tensorflow.metadata.v0.NaturalLanguageStatistics.ReportedSequences)
    })
  ,
...
_sym_db.RegisterMessage(NaturalLanguageStatistics.ReportedSequences)
_sym_db.RegisterMessage(NaturalLanguageStatistics.ReportedSequences.StringTokens)
_sym_db.RegisterMessage(NaturalLanguageStatistics.ReportedSequences.IntTokens)
