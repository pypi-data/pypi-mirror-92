...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.3.0-alpha.1611686948+b5aced23'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.3.0-alpha.1611686948+b5aced23`
                """)
            else:
                raise
