...
from automl_tools.functions.logger import seed_everything, get_stage
...
def automl_run(train=pd.DataFrame,
    ...
    get_stage(2)
    _train, _test, _id_train, _id_test, _target = get_dataset_statistical(train, test, target_col)
    get_stage(3)
    ...
    #
    # # get_stage(8)
    # # _train, _test = get_dataset_woe_processing(_train, _test, _target)
    # # get_dataset_outlier(_train, _test)
