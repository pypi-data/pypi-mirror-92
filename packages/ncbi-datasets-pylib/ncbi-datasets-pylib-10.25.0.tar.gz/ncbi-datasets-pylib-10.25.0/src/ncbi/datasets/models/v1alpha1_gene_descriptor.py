...
class V1alpha1GeneDescriptor(object):
    ...
    def __init__(self, chromosome=None, chromosomes=None, common_name=None, description=None, ensembl_gene_ids=None, gene_id=None, genomic_ranges=None, genomic_regions=None, nomenclature_authority=None, omim_ids=None, orientation=None, proteins=None, query_accessions=None, reference_standards=None, replaced_gene_id=None, rna_type=None, swiss_prot_accessions=None, symbol=None, synonyms=None, tax_id=None, taxname=None, transcripts=None, type=None, local_vars_configuration=None):  # noqa: E501
        ...
        if query_accessions is not None:
            self.query_accessions = query_accessions
    ...
    def query_accessions(self):
        """Gets the query_accessions of this V1alpha1GeneDescriptor.  # noqa: E501


        :return: The query_accessions of this V1alpha1GeneDescriptor.  # noqa: E501
        :rtype: list[str]
        """
        return self._query_accessions

    @query_accessions.setter
    def query_accessions(self, query_accessions):
        """Sets the query_accessions of this V1alpha1GeneDescriptor.


        :param query_accessions: The query_accessions of this V1alpha1GeneDescriptor.  # noqa: E501
        :type: list[str]
        """

        self._query_accessions = query_accessions
