...
class AnalyticsModelResponse(Model):
    ...
    def __init__(self, *, id: int, name: str, version: str, type=None, created=None, group_type=None, is_global: bool=None, is_deprecated: bool=None, indicators=None, properties=None, related_models=None, created_by=None, corporation=None, location=None, **kwargs) -> None:
