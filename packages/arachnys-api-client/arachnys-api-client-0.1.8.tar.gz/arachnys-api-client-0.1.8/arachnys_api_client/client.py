...
class Attribute(Dict[str, Any]):
    def __init__(self, **kwargs):
        ...
        if "child_values" not in self:
            self["child_values"] = AttributeMap()

    @property
    def children(self):
        return self.get("child_values")
    ...
    def as_dict(self) -> Dict[Any, Any]:
        ...
        ret["child_values"] = self["child_values"].as_dict()
        return ret
...
class AttributeMap:
    ...
    def __init__(
        ...
        for id in ids:
            ...
            value["child_values"] = AttributeMap(
                ids=child_ids,
                id_hash=id_hash,
    ...
    def first(self, attribute: str) -> Attribute:
        try:
            return self.get(attribute)[0]
        except IndexError:
            raise KeyError("No attributes found")
