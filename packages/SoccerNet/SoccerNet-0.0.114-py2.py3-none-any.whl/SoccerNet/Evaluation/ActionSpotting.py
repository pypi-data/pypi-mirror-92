...
def evaluate(SoccerNet_path, Predictions_path, prediction_file="results_spotting.json", split="test", version=2):
    ...
    for game in tqdm(list_games):
        ...
        # Load labels
        if version==2: label_files = "Labels-v2.json", num_classes = 17
        if version==1: label_files = "Labels.json", num_classes = 3
