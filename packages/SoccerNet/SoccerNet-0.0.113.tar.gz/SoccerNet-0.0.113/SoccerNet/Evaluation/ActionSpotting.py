...
def evaluate(SoccerNet_path, Predictions_path, prediction_file="results_spotting.json", split="test", framerate=2, version=2):
    ...
    for game in tqdm(list_games):
        ...
        # Load labels
        if version==2: label_files = "Labels-v2.json"
        if version==1: label_files = "Labels.json"
