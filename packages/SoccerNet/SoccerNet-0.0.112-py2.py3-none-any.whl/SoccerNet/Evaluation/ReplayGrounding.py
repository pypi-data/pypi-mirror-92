...
def evaluate(SoccerNet_path, Predictions_path, prediction_file="Detection-replays.json", split="test", framerate=2):
    ...
    a_mAP = average_mAP(gt_list, detections_list, framerate=framerate)
    # print("a_mAP: ",a_mAP)
    return a_mAP
