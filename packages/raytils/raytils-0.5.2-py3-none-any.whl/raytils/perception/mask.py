...
def get_volume_from_blob(mask: np.array, method: str = "surface_area", limit_method: str = "contour",
    ...
    https://en.wikipedia.org/w/index.php?title=Sphere#Surface_area
    https://www.researchgate.net/publication/2716029_Quadrature_Prefiltering_for_High_Quality_Antialiasing
