import pytest
from python.main.pyx.xml.rpc.holders.long_holder_editor import LongHolderEditor
from python.main.pyx.xml.rpc.holders.long_holder import LongHolder
from python.test.pyx.xml.rpc.holders.long_holder_test import TestLongHolder
