...
from python.main.pyx.xml.rpc.holders.string_holder_editor import StringHolderEditor
from python.main.pyx.xml.rpc.holders.string_holder import StringHolder
from python.test.pyx.xml.rpc.holders.string_holder_test import TestStringHolder
