...
from python.main.pyx.xml.rpc.holders.char_holder import CharHolder
from python.main.pyx.xml.rpc.holders.char_holder_editor import CharHolderEditor
from python.test.pyx.xml.rpc.holders.char_holder_test import TestCharHolder
