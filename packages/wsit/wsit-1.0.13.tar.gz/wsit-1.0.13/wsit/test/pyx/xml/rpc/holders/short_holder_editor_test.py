import pytest
from python.main.pyx.xml.rpc.holders.short_holder_editor import ShortHolderEditor
from python.main.pyx.xml.rpc.holders.short_holder import ShortHolder
from python.test.pyx.xml.rpc.holders.short_holder_test import TestShortHolder
