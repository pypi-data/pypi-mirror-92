import pytest
from python.main.pyx.xml.rpc.holders.uint_holder_editor import UIntHolderEditor
from python.main.pyx.xml.rpc.holders.uint_holder import UIntHolder
from python.test.pyx.xml.rpc.holders.uint_holder_test import TestUIntHolder
