import pytest
from python.main.pyx.xml.rpc.holders.ulong_holder_editor import ULongHolderEditor
from python.main.pyx.xml.rpc.holders.ulong_holder import ULongHolder
from python.test.pyx.xml.rpc.holders.ulong_holder_test import TestULongHolder
