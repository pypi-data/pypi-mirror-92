...
from python.main.pyx.xml.rpc.holders.structure_holder import StructureHolder
from python.main.pyx.xml.rpc.holders.structure_holder_editor import StructureHolderEditor
