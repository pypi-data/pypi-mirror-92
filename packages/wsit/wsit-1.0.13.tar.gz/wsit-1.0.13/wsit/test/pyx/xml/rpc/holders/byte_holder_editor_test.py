import pytest
from python.main.pyx.xml.rpc.holders.byte_holder_editor import ByteHolderEditor
from python.main.pyx.xml.rpc.holders.byte_holder import ByteHolder
from python.test.pyx.xml.rpc.holders.byte_holder_test import TestByteHolder
