...
class Client(object):
    ...
    def compute_descriptors(self,featurization,file_paths,structure_random_seed=None,return_files=False,structure_sample_size=100):
        ...
        featurization : str
            ...
            This should be 'lithium_ionic', 'transition_metal_redox', or 'molecular'.
            The 'molecular' and 'transition_metal_redox' options are disabled by default 
    ...
    def get_substance_data(self,name):
        ...
        See the documentation for
        apyonics.substances_client.SubstancesClient.get_substance_data().
        """
        resp = self.session.get(
        ...
        if resp.status_code == 200:
            respdata = {'success':True,'data':resp.json()['data']}
            return resp.json()
        else:
            return {'success':False,'status_code':resp.status_code}
