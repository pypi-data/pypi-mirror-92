...
def keltner_channel_hband_indicator(high, low, close, n=10, fillna=False):
    ...
    hband = keltner_channel_hband(high, low, close, n=n, fillna=False)  # Fix Erdogan
...
def keltner_channel_lband_indicator(high, low, close, n=10, fillna=False):
    ...
    """
    ind=np.zeros(len(close))
    lband = keltner_channel_lband(high, low, close, n=n, fillna=False)  # Fix Erdogan
...
#    return np.array(tp)
#
#def keltner_channel_(high_data, low_data, period, fillna=False):
#    """
#    Bandwidth.
#    Formula:
#    BW = SMA(H - L)
...
#    bw = talib.SMA(diff, period)
#    if fillna: bw[np.isnan(bw)]=0
#    return bw
#
#
#def keltner_channel_central(close_data, high_data, low_data, period, fillna=False):
#    """
#    Center Band.
#    Formula:
#    CB = SMA(TP)
...
#    cb = talib.SMA(tp, period)
#    if fillna: cb[np.isnan(cb)]=0
#    return cb
#
#
#def keltner_channel_hband(close_data, high_data, low_data, period, fillna=False):
#    """
#    Upper Band.
#    Formula:
#    UB = CB + BW
#    """
#    cb = keltner_channel_central(close_data, high_data, low_data, period)
#    bw = keltner_channel_(high_data, low_data, period)
#    ub = cb + bw
#    if fillna: ub[np.isnan(ub)]=0
#    return ub
#
#
#def keltner_channel_lband(close_data, high_data, low_data, period, fillna=False):
#    """
#    Lower Band.
#    Formula:
#    LB = CB - BW
