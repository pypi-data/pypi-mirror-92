...
number_of_sample_columns = number_of_samples/8
...
def run(protocol):
    ...
    # # add prok, 1x na shield and control to all samples
    ...
    #     p300.pick_up_tip(p300_box1[tip])
    #     aspirate_reagent(p300, ((sample_volume + 10) * 2), nna_lysis_buffer_beads)
    #     p300.dispense(((sample_volume + 10) * 2),
