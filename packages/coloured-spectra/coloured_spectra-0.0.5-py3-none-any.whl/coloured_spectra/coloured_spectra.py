...
__all__ = ['PLANCK_CONSTANT', 'SPEED_OF_LIGHT', 'BOLTZMAN_CONSTANT', 'Blackbody', 'piecewise_Guass', 'wavelength2xyz',
           ...
           'wavelength_intensity2hsv', 'hsv_map', 'plot_hsv_LUT_spectrum', 'colour_hyperspectral_line', 'spectra2sRGB',
           'hyperspec_line2colour']
...
# Cell
def hsv_map(λ:"wavelength nm",I:"intensity 0-1")->"HSV":
    if λ <= 425:
