...
[boto3.SagemakerEdgeManager 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
