...
[boto3.SagemakerEdgeManager 1.16.60](https://boto3.amazonaws.com/v1/documentation/api/1.16.60/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
