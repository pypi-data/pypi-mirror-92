...
class NextJsProject(
    ...
    def __init__(
        ...
        *,
        ...
        :param npm_dist_tag: (experimental) The dist-tag to use when releasing to npm. Default: "latest"
        ...
        :param npm_registry: (experimental) The registry url to use when releasing packages. Default: "registry.npmjs.org"
