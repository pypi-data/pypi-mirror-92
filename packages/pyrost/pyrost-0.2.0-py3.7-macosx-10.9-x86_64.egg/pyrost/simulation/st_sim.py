...
class STSim(DataContainer):
    ...
    """
    attr_set = {'params'}
    init_set = {'n_x', 'n_y', 'b_steps', 'b_profile', 'lens_wfx', 'lens_wfy',
                'sample_wfx', 'sample_wfy', 'det_wfx', 'det_wfy', 'det_ix', 'det_iy'}
    ...
    def _init_dict(self):
        ...
        if self.b_steps is None:
            self.b_steps = self.params.barcode_steps(dist=self.params.defocus)
    ...
    @dict_to_object
    def update_barcode_steps(self, b_steps):
