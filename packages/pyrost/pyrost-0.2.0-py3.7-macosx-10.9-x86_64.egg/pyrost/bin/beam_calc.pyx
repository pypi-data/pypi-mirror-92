...
def barcode_steps(double x0, double x1, double b_dx, double rd):
...
def barcode_profile(double[::1] b_steps, double b_atn, double b_sgm, double blk_atn, double dx, double step, int n_f, int n_x):
