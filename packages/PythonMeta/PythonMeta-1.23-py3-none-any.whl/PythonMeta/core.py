...
def Fig_Funnel (size,dpi,effs):
    ...
    for i in range(1,len(effs)):
        x.append(effs[i][1])
        y.append(effs[i][6])
        ci.append(effs[i][1]-effs[i][6]*1.96)
        ci.append(effs[i][1]+effs[i][6]*1.96)
    ...
    plt.plot ([effs[0][1],2*effs[0][1]-cimax],[0,ymax],color="blue", linestyle="--", lw=1)
    plt.plot ([effs[0][1],cimax],[0,ymax],color="blue", linestyle="--", lw=1)
