...
def test_calculate_default_optimal_heap_sizes():
    ...
    test_matrix = [
        ...
        [8, 4000, 1700, 250, 500, 250, 500, 250, 300, 250],
        [8, 8000, 3700, 500, 1000, 500, 1000, 500, 300, 500],
        [8, 12000, 5700, 750, 1500, 750, 1500, 750, 300, 750],
        [8, 16000, 7700, 1000, 2000, 1000, 2000, 1000, 300, 1000],
        [8, 32000, 15700, 2000, 4000, 2000, 4000, 2000, 300, 2000],
        [8, 64000, 35700, 4000, 8000, 4000, 4000, 4000, 300, 4000],
        [8, 128000, 75700, 8000, 16000, 8000, 4000, 8000, 300, 8000],
        [8, 256000, 155700, 16000, 32000, 16000, 4000, 16000, 300, 16000],
        # 64-bit, 64 cpu cores for screenshot purposes
        [64, 4000, 1700, 250, 500, 250, 500, 250, 300, 250],
        [64, 8000, 3700, 500, 1000, 500, 1000, 500, 300, 500],
        [64, 12000, 5700, 750, 1500, 750, 1500, 750, 300, 750],
        [64, 16000, 7700, 1000, 2000, 1000, 2000, 1000, 300, 1000],
        [64, 32000, 15700, 2000, 4000, 2000, 4000, 2000, 300, 2000],
        [64, 64000, 31700, 4000, 8000, 4000, 8000, 4000, 300, 4000],
        [64, 128000, 63700, 8000, 16000, 8000, 16000, 8000, 300, 8000],
        [64, 256000, 127700, 16000, 32000, 16000, 32000, 16000, 300, 16000],
        [64, 512000, 287700, 32000, 64000, 32000, 32000, 32000, 300, 32000],
    ]
