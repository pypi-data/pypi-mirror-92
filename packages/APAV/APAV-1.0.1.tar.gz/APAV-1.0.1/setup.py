...
dirs = glob(join("apav", "resources", "*"))
for folder in dirs:
    print(folder)
    files = glob(join(folder, "*"), recursive=True)
...
setuptools.setup(
    ...
    keywords=["atom probe", "tomography", "atom probe tomography", "field evaporation",
              "leap", "lawatap", "apt", "materials", "science", "3dapt"],
    classifiers=[
