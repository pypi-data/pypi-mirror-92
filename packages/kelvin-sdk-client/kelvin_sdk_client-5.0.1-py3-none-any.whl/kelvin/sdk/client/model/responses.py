...
from . import Labels, Logs, Type1, pagination, requests
...
class ACP(DataModelBase):
    ...
    def list_acp(
        ...
        **Permission Required:** `kelvin.permission.acp.read`.
        ...
        return result.fetch() if fetch else result
...
class PrometheusTarget(DataModelBase):
    """
    PrometheusTarget object.
    ...
    def create_prometheus_target(
        self_or_cls,
        data: Optional[Union[requests.TargetCreate, Mapping[str, Any]]] = None,
        dry_run: bool = False,
        client: Any = None,
        **kwargs: Any,
    ) -> None:
        ...
        **Permission Required:** `kelvin.permission.prometheus.create`.

        ``createPrometheusTarget``: ``POST`` ``/api/v4/prometheus/target/create``

        Parameters
        ----------
        data: requests.TargetCreate, optional
        **kwargs:
            Extra parameters for requests.TargetCreate
        ...
        result = self_or_cls._make_request(
            client,
            "post",
            "/api/v4/prometheus/target/create",
            {},
            {},
            {},
            {},
            data,
            requests.TargetCreate,
            False,
    ...
    def list_prometheus_target(
        ...
        dry_run: bool = False,
        client: Any = None,
    ) -> Union[Sequence[PrometheusTarget], PrometheusTargetListPaginated]:
        """
        List Prometheus Target

        **Pagination Key:** `target_name`

        **Permission Required:** `kelvin.permission.prometheus.read`.

        ``listPrometheusTarget``: ``GET`` ``/api/v4/prometheus/target/list``

        Parameters
        ----------
        search : :obj:`Sequence[str]`
            Search Prometheus target by name
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 200. Default: 20
        starting_after : :obj:`str`
            Lower bound cursor for use in pagination
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": PrometheusTargetListPaginated, "400": ErrorMessages, "401": ErrorMessages},
            False,
            dry_run,
        )
        return result.fetch() if fetch else result
    ...
    @instance_classmethod
    @DataModelBase.translate()
    def delete_prometheus_target(
        self_or_cls, name: str, dry_run: bool = False, client: Any = None
    ) -> PrometheusTarget:
        """
        Delete Prometheus Target

        **Permission Required:** `kelvin.permission.prometheus.delete`.

        ``deletePrometheusTarget``: ``POST`` ``/api/v4/prometheus/target/{name}/delete``
        ...
        result = self_or_cls._make_request(
            client,
            "post",
            "/api/v4/prometheus/target/{name}/delete",
            {"name": name},
            {},
            {},
            {},
    ...
    @instance_classmethod
    @DataModelBase.translate()
    def get_prometheus_target(
        self_or_cls, name: str, dry_run: bool = False, client: Any = None
    ) -> PrometheusTarget:
        """
        Get Prometheus Target

        **Permission Required:** `kelvin.permission.prometheus.read`.

        ``getPrometheusTarget``: ``GET`` ``/api/v4/prometheus/target/{name}/get``
        ...
        result = self_or_cls._make_request(
            client,
            "get",
            "/api/v4/prometheus/target/{name}/get",
            {"name": name},
            {},
            {},
            {},
...
class PrometheusTargetListPaginated(PaginatorDataModel[PrometheusTarget]):
    """
    PrometheusTargetListPaginated object.

    Parameters
    ----------
    data: Optional[List[PrometheusTarget]]
    pagination: Optional[pagination.Pagination]

    """

    data: Optional[List[PrometheusTarget]] = None
    pagination: Optional[pagination.Pagination] = None
