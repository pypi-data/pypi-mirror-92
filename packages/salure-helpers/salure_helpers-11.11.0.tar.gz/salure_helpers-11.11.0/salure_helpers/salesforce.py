...
class Salesforce(object):
    ...
    """
    def __init__(self, customer_url: str, client_id: str, client_secret: str, authorization_code: str, redirect_uri: str = None):
        ...
        self.access_token = ''
        self.__get_refresh_token(authorization_code=authorization_code)

    def __get_refresh_token(self, authorization_code: str):
        """
