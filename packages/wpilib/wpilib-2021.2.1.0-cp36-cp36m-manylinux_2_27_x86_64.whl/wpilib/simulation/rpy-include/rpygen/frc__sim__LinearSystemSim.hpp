...
template <typename CxxBase, int States, int Inputs, int Outputs>
struct Pyfrc__sim__LinearSystemSim : CxxBase {
...
struct bind_frc__sim__LinearSystemSim {
    ...
    py::class_<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, std::shared_ptr<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>>, rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>> cls_LinearSystemSim;
...
":returns: The current drawn by this simulated mechanism.")
      ...
      .def("_updateX", static_cast<Eigen::Matrix<double, States, 1 > (frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(const Eigen::Matrix<double, States, 1>&, const Eigen::Matrix<double, Inputs, 1>&, units::second_t)>(&rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::UpdateX),
...
":param dt:          The time difference between controller updates.")
      ...
      .def("_clampInput", static_cast<Eigen::Matrix<double, Inputs, 1 > (frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(Eigen::Matrix<double, Inputs, 1 >)>(&rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::ClampInput),
      py::arg("u"), release_gil(), py::doc(
...
":returns: The normalized input.")
    ...
    .def_readonly("_m_plant", &rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::m_plant)    .def_readonly("_m_x", &rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::m_x)    .def_readonly("_m_y", &rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::m_y)    .def_readonly("_m_u", &rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::m_u)    .def_readonly("_m_measurementStdDevs", &rpygen::Pyfrc__sim__LinearSystemSim<typename frc::sim::LinearSystemSim<States, Inputs, Outputs>, States, Inputs, Outputs>::m_measurementStdDevs);
