...
class SteeringIDDS():
    ...
    def run_generator(self, space, n_point, metric=kDefaultMetric,
        ...
        if parsed_data is None:
            ...
            new_points = generate_points(search_space=search_space, n_point=n_point,
        ...
        # old format
            ...
            for model_id in parsed_data:
                ...
                model_specific_new_points = generate_points(search_space=search_space, n_point=n_point,
                                                            metric=metric, mode=mode,
                                                            lib=lib, max_point=max_point, 
                                                            points=points, results=results, **args)
                new_points[model_id].append(tuple([model_id, model_specific_new_points]))
