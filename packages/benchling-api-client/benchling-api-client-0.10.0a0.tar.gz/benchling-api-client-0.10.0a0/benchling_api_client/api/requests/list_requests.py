...
from ...models.list_requests_request_status import ListRequestsRequestStatus
...
def _get_kwargs(
    *,
    client: Client,
    schema_id: str,
    request_status: Union[Unset, None, ListRequestsRequestStatus] = UNSET,
    ...
    json_request_status: Union[Unset, ListRequestsRequestStatus] = UNSET
    if not isinstance(request_status, Unset) and request_status is not None:
        json_request_status = request_status

    params: Dict[str, Any] = {
        "schemaId": schema_id,
    }
    if request_status is not UNSET and request_status is not None:
        params["requestStatus"] = json_request_status
    if min_created_time is not UNSET and min_created_time is not None:
        params["minCreatedTime"] = min_created_time
    if max_created_time is not UNSET and max_created_time is not None:
