...
class Entry:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        review_record: Union[None, Unset, Dict[str, Any]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _review_record is not None and not isinstance(_review_record, Unset):
            review_record = EntryReviewRecord.from_dict(cast(Dict[str, Any], _review_record))

        schema: Union[Unset, EntrySchema] = UNSET
        _schema = d.pop("schema", UNSET)
        if _schema is not None and not isinstance(_schema, Unset):
            schema = EntrySchema.from_dict(cast(Dict[str, Any], _schema))
