...
def _get_kwargs(
    *,
    ...
    if created_atgte is not UNSET and created_atgte is not None:
        params["createdAt.gte"] = created_atgte
    if starting_after is not UNSET and starting_after is not None:
        params["startingAfter"] = starting_after
    if event_types is not UNSET and event_types is not None:
        params["eventTypes"] = event_types
    if poll is not UNSET and poll is not None:
        params["poll"] = poll
