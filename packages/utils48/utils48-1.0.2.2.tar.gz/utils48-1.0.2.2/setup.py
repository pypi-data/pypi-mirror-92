...
setup(
  ...
  version = "1.0.2.2",      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/48panda48/48util/archive/1.0.2.2.tar.gz',    # I explain this later on
  )
