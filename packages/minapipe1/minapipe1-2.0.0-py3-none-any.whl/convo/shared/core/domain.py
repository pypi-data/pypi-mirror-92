...
from convo.shared.exceptions import ConvoException, YamlException
from convo.shared.utils.validation import YamlValidationException
...
class Domain:
    ...
    def is_retrieval_intent_template(
        ...
        """
        return convo.shared.nlu.constants.RESPONSE_IDENTIFIER_DELIMITER in template[0]
