...
class MessageProcessor:
    ...
    def predict_next_action(
        ...
        action = convo.core.actions.action.action_for_index(
    ...
    def _get_action(self, action_name) -> Optional[convo.core.actions.action.Action]:
        return convo.core.actions.action.action_for_name(
    ...
    async def _run_action(
        ...
        except convo.core.actions.action.ActionExecutionRejection:
