...
EndpointTypeDef = TypedDict(
    "EndpointTypeDef",
    {"Address": str, "Port": int, "VpcEndpoints": List["SpartaProxyVpcEndpointTypeDef"]},
    total=False,
)
...
SpartaProxyVpcEndpointTypeDef = TypedDict(
    "SpartaProxyVpcEndpointTypeDef", {"VpcEndpointId": str}, total=False
)
