...
At the moment, we provide interfaces for the following models: [Opus-MT](#Opus-MT) from [Helsinki-NLP](https://github.com/Helsinki-NLP/Opus-MT),  [mBART50_m2m](#mBART_50) from [Facebook Research](https://arxiv.org/abs/2008.00401), and [M2M_100](#M2M_100) from [Facebook Research](https://arxiv.org/abs/2010.11125).
