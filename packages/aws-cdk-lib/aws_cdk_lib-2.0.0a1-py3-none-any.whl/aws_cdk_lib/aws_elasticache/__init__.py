...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        authentication: typing.Optional[typing.Union["CfnUser.AuthenticationProperty", _IResolvable_6e2f5d88]] = None,
    ...
    def authentication(
        self,
    ) -> typing.Optional[typing.Union["CfnUser.AuthenticationProperty", _IResolvable_6e2f5d88]]:
        """``AWS::ElastiCache::User.Authentication``.

        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-user.html#cfn-elasticache-user-authentication
        """
    ...
    def authentication(
        self,
        value: typing.Optional[typing.Union["CfnUser.AuthenticationProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    @jsii.member(jsii_name="userGroupIds")
    def user_group_ids(self) -> typing.Optional[typing.List[builtins.str]]:
        """``AWS::ElastiCache::User.UserGroupIds``.

        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-user.html#cfn-elasticache-user-usergroupids
        """
        return jsii.get(self, "userGroupIds")
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_elasticache.CfnUser.AuthenticationProperty",
        jsii_struct_bases=[],
    ...
    class AuthenticationProperty:
        def __init__(
            ...
            *,
            ...
            """
            :param password_count: ``CfnUser.AuthenticationProperty.PasswordCount``.
            :param type: ``CfnUser.AuthenticationProperty.Type``.
        ...
        def password_count(self) -> typing.Optional[jsii.Number]:
            """``CfnUser.AuthenticationProperty.PasswordCount``.
        ...
        def type(self) -> typing.Optional[builtins.str]:
            """``CfnUser.AuthenticationProperty.Type``.
...
class CfnUserGroup(
    ...
    def __init__(
        ...
        *,
        ...
        pending_changes: typing.Optional[typing.Union["CfnUserGroup.UserGroupPendingChangesProperty", _IResolvable_6e2f5d88]] = None,
        replication_group_ids: typing.Optional[typing.List[builtins.str]] = None,
        ...
        :param pending_changes: ``AWS::ElastiCache::UserGroup.PendingChanges``.
        :param replication_group_ids: ``AWS::ElastiCache::UserGroup.ReplicationGroupIds``.
    ...
    def pending_changes(
        self,
    ) -> typing.Optional[typing.Union["CfnUserGroup.UserGroupPendingChangesProperty", _IResolvable_6e2f5d88]]:
        """``AWS::ElastiCache::UserGroup.PendingChanges``.

        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-usergroup.html#cfn-elasticache-usergroup-pendingchanges
        """
        return jsii.get(self, "pendingChanges")

    @pending_changes.setter # type: ignore
    def pending_changes(
        self,
        value: typing.Optional[typing.Union["CfnUserGroup.UserGroupPendingChangesProperty", _IResolvable_6e2f5d88]],
    ) -> None:
        jsii.set(self, "pendingChanges", value)

    @builtins.property # type: ignore
    @jsii.member(jsii_name="replicationGroupIds")
    def replication_group_ids(self) -> typing.Optional[typing.List[builtins.str]]:
        """``AWS::ElastiCache::UserGroup.ReplicationGroupIds``.

        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-usergroup.html#cfn-elasticache-usergroup-replicationgroupids
        """
        return jsii.get(self, "replicationGroupIds")

    @replication_group_ids.setter # type: ignore
    def replication_group_ids(
        self,
        value: typing.Optional[typing.List[builtins.str]],
    ) -> None:
        jsii.set(self, "replicationGroupIds", value)
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_elasticache.CfnUserGroup.UserGroupPendingChangesProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class UserGroupPendingChangesProperty:
        def __init__(
            self,
            *,
            user_ids_to_add: typing.Optional[typing.List[builtins.str]] = None,
            user_ids_to_remove: typing.Optional[typing.List[builtins.str]] = None,
        ) -> None:
            """
            :param user_ids_to_add: ``CfnUserGroup.UserGroupPendingChangesProperty.UserIdsToAdd``.
            :param user_ids_to_remove: ``CfnUserGroup.UserGroupPendingChangesProperty.UserIdsToRemove``.
            ...
            if user_ids_to_add is not None:
                self._values["user_ids_to_add"] = user_ids_to_add
            if user_ids_to_remove is not None:
                self._values["user_ids_to_remove"] = user_ids_to_remove

        @builtins.property
        def user_ids_to_add(self) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUserGroup.UserGroupPendingChangesProperty.UserIdsToAdd``.
            ...
            """
            result = self._values.get("user_ids_to_add")
            return result

        @builtins.property
        def user_ids_to_remove(self) -> typing.Optional[typing.List[builtins.str]]:
            """``CfnUserGroup.UserGroupPendingChangesProperty.UserIdsToRemove``.
            ...
            """
            result = self._values.get("user_ids_to_remove")
            return result
        ...
        def __repr__(self) -> str:
            return "UserGroupPendingChangesProperty(%s)" % ", ".join(
                k + "=" + repr(v) for k, v in self._values.items()
            )
...
class CfnUserGroupProps:
    def __init__(
        ...
        *,
        ...
        if pending_changes is not None:
            self._values["pending_changes"] = pending_changes
        if replication_group_ids is not None:
            self._values["replication_group_ids"] = replication_group_ids
    ...
    def pending_changes(
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-usergroup.html#cfn-elasticache-usergroup-pendingchanges
        """
        result = self._values.get("pending_changes")
        return result
    ...
    def replication_group_ids(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-usergroup.html#cfn-elasticache-usergroup-replicationgroupids
        """
        result = self._values.get("replication_group_ids")
        return result
