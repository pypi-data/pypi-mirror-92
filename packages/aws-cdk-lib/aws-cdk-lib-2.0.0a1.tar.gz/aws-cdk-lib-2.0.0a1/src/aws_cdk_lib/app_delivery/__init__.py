...
import constructs
from .. import Stack as _Stack_fac7efe4
...
class PipelineDeployStackAction(
    ...
    jsii_type="aws-cdk-lib.app_delivery.PipelineDeployStackAction",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.app_delivery.PipelineDeployStackActionProps",
    jsii_struct_bases=[],
    name_mapping={
