...
class NeuralNetDialog(ClassifierDialogABC):
    ...
    def _open_notebook_path_dialog(self) -> bool:
        fname = QtWidgets.QFileDialog.getSaveFileName(None, 'Save notebook ...', NeuralNetDialog.notebook_path,
                                                      filter='Notebook (*.ipynb)')

        self.notebook_path_edit.setText(fname[0])
