...
class ListBackendJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBackendJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.58/reference/services/amplifybackend.html#AmplifyBackend.Paginator.ListBackendJobs.paginate)
        """
