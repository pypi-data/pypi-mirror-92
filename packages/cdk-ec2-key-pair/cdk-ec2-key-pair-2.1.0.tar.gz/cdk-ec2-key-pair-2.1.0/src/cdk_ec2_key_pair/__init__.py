...
class KeyPair(
    ...
    def grant_read_on_private_key(
        ...
        :param grantee: -
        """
        return jsii.invoke(self, "grantReadOnPrivateKey", [grantee])
    ...
    def grant_read_on_public_key(
        ...
        :param grantee: -
        """
        return jsii.invoke(self, "grantReadOnPublicKey", [grantee])

    @builtins.property # type: ignore
    @jsii.member(jsii_name="keyPairID")
    def key_pair_id(self) -> builtins.str:
        """ID of the Key Pair."""
        return jsii.get(self, "keyPairID")
    ...
    def public_key_value(self) -> builtins.str:
        ...
        """
        return jsii.get(self, "publicKeyValue")
