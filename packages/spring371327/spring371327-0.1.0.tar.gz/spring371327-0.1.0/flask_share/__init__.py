...
class Share(object):
    ...
    def init_app(self, app):
        ...
        blueprint = Blueprint(name='share', import_name=__name__, static_folder='static', static_url_path='/share'+app.static_url_path)
    ...
    def load(css_url=None, js_url=None, serve_local=False):
        """
        加载 share.js 静态资源，如 css 和 javascript
        :param css_url: if set, will be used as css_url
        :param js_url: if set, will be used as js_url
    ...
    def create(title="", sites=None, mobile_sites=None, align='left', addition_class=''):
        ...
        :param mobile_sites: the sited displayed on mobile.
        ...
        return Markup('''<div class="social-share %s" data-sites="%s" data-mobile-sites="%s" align="%s">%s</div>''' % (addition_class, sites, mobile_sites, align, title))
