...
from skyext.intercepter.db_session_intercepter import db_session_decorator
...
class GoodsManager(object):
    ...
    def get_test(self, **params):
        ...
        if params and not params.keys().__contains__('id'):
            raise Exception("find goods, params[id] is not existed")

        session = params.get("db_session")
