...
def main():
    ...
    # waspas.set_weights_by_ranking_B_POW(0)
                                       ...
                                       # C1   C2     C3   C4 
    w_AHP = wpm.set_weights_by_AHP([[  1,    4,    5,   7],   # C1
                                       [1/4,    1,    3,   5],   # C2
                                       [1/5,  1/3,    1,   3],   # C3
                                       [1/7,  1/5,  1/3,   1]])  # C4
    print("AHP Returned:\n", w_AHP)
    wpm.set_signals([MIN, MAX, MAX, MAX])

    wpm.decide()
    print("WEIGHTS:\n", wpm.weights)
    print("NORMALIZED:\n", wpm.pretty_normalized())
    print("WEIGHTED:\n", wpm.pretty_weighted())
    print("RANKING WPM with", wpm.normalization_method , ":\n", wpm.pretty_decision())
