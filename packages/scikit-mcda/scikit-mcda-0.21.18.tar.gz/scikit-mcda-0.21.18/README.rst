...
- Weighted Sum Model (WSM), Weighted Product Model (WPM) , Weighted Aggregated Sum Product Assessment (WASPAS), Technique for Order Preference by Similarity to an Ideal Solution (TOPSIS), Preference Ranking Organization METHod for Enrichment of Evaluations (PROMETHEE II) ...
...
- Class PROMETHEEII: decide(normalization_method=LinearMinMax\_)

Attributes of TOPSIS Class:
  - df_pis
  - df_nis
  - df_distances
...
--------------------
    ...
    from scikitmcda.prometheeii import PROMETHEEII
