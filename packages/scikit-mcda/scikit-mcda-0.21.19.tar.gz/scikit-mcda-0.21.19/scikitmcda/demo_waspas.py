...
def main():
    ...
    # waspas.set_weights_by_ranking_B_POW(0)
                                       ...
                                       # C1   C2     C3   C4 
    w_AHP = waspas.set_weights_by_AHP([[  1,    4,    5,   7],   # C1
                                       [1/4,    1,    3,   5],   # C2
                                       [1/5,  1/3,    1,   3],   # C3
                                       [1/7,  1/5,  1/3,   1]])  # C4
    print("AHP Returned:\n", w_AHP)
    waspas.set_signals([MIN, MAX, MAX, MAX])

    waspas.decide()
    print("WEIGHTS:\n", waspas.weights)
    print("NORMALIZED:\n", waspas.pretty_normalized())
    print("WEIGHTED:\n", waspas.pretty_weighted())
    print("RANKING WASPAS with", waspas.normalization_method , ":\n", waspas.pretty_decision())

    waspas.decide(0.5, Vector_)
    print("RANKING WASPAS with", waspas.normalization_method, ":\n", waspas.pretty_decision())
