define ([
    ...
    "use strict";
    /**
     * @class NpIdentityCodeValidator
     * @constructor
    */
    var NpIdentityCodeValidator = function() {
    ...
    */
    NpIdentityCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);

    /**
    * NumpyCodeValidator 클래스의 makeCode 메소드 오버라이드
    * @param {Obejct} state 
    */
    NpIdentityCodeValidator.prototype.validate = function(state) {
        const { paramData
            , returnVariable
            , dtype
            , isReturnVariable
    ...
    return NpIdentityCodeValidator;
});
