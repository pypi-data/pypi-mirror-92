define ([
    ...
    /**
     * @class NpDsplitHsplitVsplitCodeValidator
     * @constructor
    */
    var NpDsplitHsplitVsplitCodeValidator = function() {
    ...
    */
    NpDsplitHsplitVsplitCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);

    /**
     * NumpyCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    NpDsplitHsplitVsplitCodeValidator.prototype.validate = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , isReturnVariable
        ...
        */
        ...
        switch (paramOption) {
            ...
            case "4" : { 
                if (this.validateOneArrayTypeNumber(paramOption4DataArray)) {
                    return false;
                }
    ...
    return NpDsplitHsplitVsplitCodeValidator;
});
