define ([
    ...
    /**
     * @class NpArrayCodeValidator
     * @constructor
    */
    var NpArrayCodeValidator = function() {
    ...
    */
    NpArrayCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);

    /**
     * NumpyCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    NpArrayCodeValidator.prototype.validate = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , dtype
