define ([
    ...
    /**
     * @class NpSumCodeValidator
     * @constructor
    */
    var NpSumCodeValidator = function() {
    ...
    */
    NpSumCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);
    ...
    */
    NpSumCodeValidator.prototype.validate = function(state) {
        const { paramData
                , returnVariable
                , isReturnVariable
