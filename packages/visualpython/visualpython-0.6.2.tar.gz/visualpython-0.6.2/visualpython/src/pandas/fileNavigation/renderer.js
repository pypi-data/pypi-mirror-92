define([
    ...
    FileNavigationRenderer.prototype.initRender = function() {
        ...
        if(fileNavigationtype === 'SAVE_FILE'){
            ...
            $('.fileNavigationPage-savebutton').append(saveFileDataInput);
            $('.fileNavigationPage-savebutton').append(saveFileDataBtn);
    ...
    /** */
    FileNavigationRenderer.prototype.renderCurrentDirPathInfo = function(dirInfoArr) {
        $('.fileNavigationPage-directory-container').empty();

        var currentDirRootDom = $(`<div class='fileNavigationPage-right'>
                                  </div>`);
        var { folderArr } = this.makeFolderOrFileDomArr(dirInfoArr);
    
        currentDirRootDom.appendTo('.fileNavigationPage-directory-container');
        var fileNavigationPageUl = $('.fileNavigationPage-ul');
    ...
    FileNavigationRenderer.prototype.renderCurrentDirPathInfoRightBody = function(dirInfoArr) {
        $('.fileNavigationPage-right').empty();
        var currentDirRootDom = $(`<div class='fileNavigationPage-body'></div>`);
        ...
        currentDirRootDom.appendTo('.fileNavigationPage-right');
    }
    ...
    FileNavigationRenderer.prototype.finishLoadingBarAndSetCurrDirStr = function(currentDirStr, currentRelativePathStr) {
        ...
        // $('.fileNavigationPage-directory-container').find('#vp_loadingBar').remove();
    }
