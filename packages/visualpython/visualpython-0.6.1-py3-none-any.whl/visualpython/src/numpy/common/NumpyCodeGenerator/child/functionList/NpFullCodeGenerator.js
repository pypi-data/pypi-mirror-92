define ([
    ...
    /**
     * @class NpFullCodeGenerator
     * @constructor
    */
    var NpFullCodeGenerator = function() {

    };
    /**
     * NumpyCodeGenerator 에서 상속
    */
    NpFullCodeGenerator.prototype = Object.create(NumpyCodeGenerator.prototype);

    /**
     * NumpyCodeGenerator makeCode 메소드 오버라이드
     * @param {Obejct} state 
     */
    NpFullCodeGenerator.prototype.makeCode = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , indexValue
        ...
        var codeObject = {
            ...
            numpyFunctionName: "full",
            paramStr: `${paramStr},${indexValue}`, 
            dtypeStr: dtype,
