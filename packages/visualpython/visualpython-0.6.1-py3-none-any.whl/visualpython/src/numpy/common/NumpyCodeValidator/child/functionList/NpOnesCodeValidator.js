define ([
    ...
    "use strict";
    /**
     * @class NpOnesCodeValidator
     * @constructor
    */
    var NpOnesCodeValidator = function() {
    ...
    */
    NpOnesCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);

    /**
    * NumpyCodeValidator 클래스의 makeCode 메소드 오버라이드
    * @param {Obejct} state 
    */
    NpOnesCodeValidator.prototype.validate = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , dtype
