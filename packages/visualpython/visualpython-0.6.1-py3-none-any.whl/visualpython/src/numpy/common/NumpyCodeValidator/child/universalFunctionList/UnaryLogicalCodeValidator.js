define ([
    ...
    /**
     * @class UnaryLogicalCodeValidator
     * @constructor
    */
    var UnaryLogicalCodeValidator = function() {
    ...
    */
    UnaryLogicalCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);

    /**
     * NumpyCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    UnaryLogicalCodeValidator.prototype.validate = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , dtype
        ...
        */
        ...
        switch (paramOption) {
            ...
            // param 옵션 3: 3차원 array validation
            case "3" : {
    ...
    return UnaryLogicalCodeValidator;
});
