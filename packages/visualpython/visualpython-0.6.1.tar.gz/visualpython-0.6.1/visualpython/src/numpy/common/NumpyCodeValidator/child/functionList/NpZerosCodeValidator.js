define ([
    ...
    "use strict";
    /**
     * @class NpZerosCodeValidator
     * @constructor
    */
    var NpZerosCodeValidator = function() {
    ...
    */
    NpZerosCodeValidator.prototype = Object.create(NumpyCodeValidator.prototype);
    ...
    */
    NpZerosCodeValidator.prototype.validate = function(state) {
        const { paramOption
                , paramData
                , returnVariable
                , dtype
