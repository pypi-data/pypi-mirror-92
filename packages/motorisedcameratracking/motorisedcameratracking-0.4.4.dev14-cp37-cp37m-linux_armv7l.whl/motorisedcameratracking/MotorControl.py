...
class MotorControl:
    ...
    def updater(self,controlQueue,xVQueue,yVQueue):#fix this
        ...
        while True:
            ...
            self.yVQueue.put(self.yVelocity)
    ...
    def main(self,q,controlQueue):
        ...
        t1=threading.Thread(target=self.updater,args=(controlQueue,self.xVQueue,self.yVQueue))
        #t2=threading.Thread(target=self.xMotor,args=(controlQueue,))
        #t3=threading.Thread(target=self.yMotor,args=(controlQueue,))
        t1.start()
        #t2.start()
