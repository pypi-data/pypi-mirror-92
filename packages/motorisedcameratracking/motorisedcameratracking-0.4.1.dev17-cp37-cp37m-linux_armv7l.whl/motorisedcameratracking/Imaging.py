...
class Imaging:
    ...
    def __init__(self, q, controlQueue,imageReturnQueue, target: str, camera: dict = {'name': 'RPICam','orientation': 180,'Width':1280,'Height':720},mode='advanced'):
...
class ObjectRecognition:
    ...
    def ORFaces(self,img):
        ...
        """
        a=Cofig(0.5)
        faceCascade = cv2.CascadeClassifier(a.getFaceClassifiersPath())
