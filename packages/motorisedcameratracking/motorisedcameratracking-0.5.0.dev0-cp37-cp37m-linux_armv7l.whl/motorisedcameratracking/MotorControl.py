...
class MotorControl:
    ...
    def recentre(self):
        ...
        self.M1.runDisplacement(-self.getXDisplacement())
        self.M2.runDisplacement(-self.getYDisplacement())
        self.xDisplacement=0
        self.yDipslacmeent=0
        self.xVelocity=0
        self.yVelocity=0
        self.trackingThread=threading.Thread(target=self.updater,args=(self.xVQueue,self.yVQueue,self.xDQueue,self.yDQueue,))
        self.trackingThread.start()
