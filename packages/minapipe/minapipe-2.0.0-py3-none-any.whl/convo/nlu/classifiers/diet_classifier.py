...
from convo.utils.tensorflow.models import ConvoModel, TransformerConvoModel
...
class DIETClassifier(IntentClassifier, EntityExtractor):
    ...
    def persist(self, file_name: Text, model_dir: Text) -> Dict[Text, Any]:
        ...
        convo.shared.utils.io.create_directory_for_file(tf_model_file)
    ...
    def _load_from_files(cls, meta: Dict[Text, Any], model_dir: Text):
        ...
        label_data = ConvoModelData(data=label_data)
        index_label_id_mapping = io_utils.json_unpickle(
            model_dir / f"{file_name}.index_label_id_mapping.json"
        )
        entity_tag_specs = convo.shared.utils.io.read_json_file(
    ...
    def _load_model(
        ...
        model_data_example = ConvoModelData(
    ...
    def _instantiate_model_class(self, model_data: ConvoModelData) -> "ConvoModel":
...
class DIET(TransformerConvoModel):
    def __init__(
        self,
    ...
    def _update_metrics_to_log(self) -> None:
        debug_log_level = logging.getLogger("convo").level == logging.DEBUG
