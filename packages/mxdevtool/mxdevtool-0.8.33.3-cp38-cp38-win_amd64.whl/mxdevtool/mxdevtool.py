...
class Matrix(object):
    ...
    def toList(self) -> "std::vector< std::vector< Real,std::allocator< Real > >,std::allocator< std::vector< Real,std::allocator< Real > > > >":
        r"""toList(Matrix self) -> DoubleVectorVector"""
        return _mxdevtool.Matrix_toList(self)
