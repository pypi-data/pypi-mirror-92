...
class CaptureBasicFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureMacAddressFilter, CaptureBasicFilter, CaptureCustomFilter]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceEthernet, DeviceIpv6, DeviceContainerIpv4, Device, DeviceBgpv4]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowEthernetPause, FlowVxlan, FlowGtpv2, FlowHeader, FlowEthernet, FlowIpv6, FlowCustom, FlowIpv4, FlowPfcPause, FlowVlan, FlowUdp, FlowTcp, FlowGtpv1, FlowGre]
        return self._getitem(key)
