...
class Capture(SnappiObject):
    ...
    def __init__(self, parent=None, choice=None, port_names=None, enable=None, overwrite=None, format=None, name=None):
    ...
    @property
    def choice(self):
        # type: () -> Union[basic, pcap, choice, choice, choice]
        """choice getter

        The type of filter.

        Returns: Union[basic, pcap, choice, choice, choice]
        """
        return self._get_property('choice')
    ...
    def choice(self, value):
        ...
        value: Union[basic, pcap, choice, choice, choice]
        """
        self._set_property('choice', value)
    ...
    def basic(self):
        ...
        """
        return self._get_property('basic', CaptureBasicFilterList)
    ...
    def pcap(self):
        ...
        Returns: str
        """
        return self._get_property('pcap')
    ...
    def pcap(self, value):
        ...
        value: str
        """
        self._set_property('pcap', value, 'pcap')
...
class CaptureBasicFilter(SnappiObject):
    ...
    def __init__(self, parent=None, choice=None, and_operator=None, not_operator=None):
    ...
    def mac_address(self):
        ...
        """Factory property that returns an instance of the CaptureMacAddressFilter class

        A container for a mac address capture filter.
        """
        return self._get_property('mac_address', CaptureMacAddressFilter(self, 'mac_address'))

    @property
    def custom(self):
        # type: () -> CaptureCustomFilter
        """Factory property that returns an instance of the CaptureCustomFilter class

        A container for a custom capture filter.
        """
        return self._get_property('custom', CaptureCustomFilter(self, 'custom'))
    ...
    def and_operator(self):
        ...
        Returns: boolean
        """
        return self._get_property('and_operator')
    ...
    def and_operator(self, value):
        ...
        value: boolean
        """
        self._set_property('and_operator', value)
    ...
    def not_operator(self):
        ...
        Returns: boolean
        """
        return self._get_property('not_operator')
    ...
    def not_operator(self, value):
        ...
        value: boolean
        """
        self._set_property('not_operator', value)
...
class CaptureMacAddressFilter(SnappiObject):
    ...
    def __init__(self, parent=None, choice=None, mac=None, filter=None, mask=None):
    ...
    def filter(self, value):
        ...
        value: str
        """
        self._set_property('filter', value)
...
class CaptureCustomFilter(SnappiObject):
    ...
    def __init__(self, parent=None, choice=None, filter=None, mask=None, offset=None):
...
class CaptureBasicFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureCustomFilter, CaptureBasicFilter, CaptureMacAddressFilter]
        return self._getitem(key)
    ...
    def basicfilter(self, and_operator=True, not_operator=False):
        ...
        """
        item = CaptureBasicFilter(and_operator=and_operator, not_operator=not_operator)
        self._add(item)
        return self
...
class CaptureList(SnappiList):
    ...
    def capture(self, port_names=None, pcap=None, enable=True, overwrite=False, format='pcap', name=None):
        ...
        """
        item = Capture(port_names=port_names, pcap=pcap, enable=enable, overwrite=overwrite, format=format, name=name)
        self._add(item)
        return self
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[Device, DeviceContainerIpv4, DeviceIpv6, DeviceBgpv4, DeviceEthernet]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowGre, FlowVlan, FlowGtpv1, FlowPfcPause, FlowIpv6, FlowHeader, FlowGtpv2, FlowEthernetPause, FlowTcp, FlowVxlan, FlowEthernet, FlowIpv4, FlowCustom, FlowUdp]
        return self._getitem(key)
