...
class CaptureBasicFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureBasicFilter, CaptureCustomFilter, CaptureMacAddressFilter]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceContainerIpv4, DeviceBgpv4, Device, DeviceEthernet, DeviceIpv6]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowIpv4, FlowHeader, FlowTcp, FlowGtpv2, FlowVlan, FlowVxlan, FlowEthernetPause, FlowEthernet, FlowUdp, FlowGre, FlowGtpv1, FlowPfcPause, FlowCustom, FlowIpv6]
        return self._getitem(key)
