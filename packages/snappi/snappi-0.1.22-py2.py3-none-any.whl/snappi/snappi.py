...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowIpv4, FlowTcp, FlowVxlan, FlowUdp, FlowIpv6, FlowGre, FlowEthernetPause, FlowGtpv1, FlowHeader, FlowEthernet, FlowVlan, FlowGtpv2, FlowPfcPause, FlowCustom]
        return self._getitem(key)
