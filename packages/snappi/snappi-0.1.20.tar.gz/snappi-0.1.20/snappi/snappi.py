...
class CaptureBasicFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureBasicFilter, CaptureMacAddressFilter, CaptureCustomFilter]
        return self._getitem(key)
...
class DeviceList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[DeviceEthernet, DeviceContainerIpv4, DeviceIpv6, DeviceBgpv4, Device]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowVlan, FlowGtpv2, FlowCustom, FlowHeader, FlowGre, FlowIpv4, FlowTcp, FlowIpv6, FlowEthernetPause, FlowGtpv1, FlowPfcPause, FlowUdp, FlowVxlan, FlowEthernet]
        return self._getitem(key)
