...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowEthernetPause, FlowGre, FlowHeader, FlowEthernet, FlowUdp, FlowVxlan, FlowVlan, FlowTcp, FlowGtpv1, FlowPfcPause, FlowIpv6, FlowGtpv2, FlowCustom, FlowIpv4]
        return self._getitem(key)
