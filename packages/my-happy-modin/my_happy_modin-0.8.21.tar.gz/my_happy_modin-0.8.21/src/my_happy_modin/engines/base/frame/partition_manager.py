...
class BaseFrameManager(ABC):
    ...
    def broadcast_axis_partitions(
        ...
        keep_partitioning : boolean. Default is False
            The flag to keep partitions for my_happy_modin Frame.
        apply_indices : list of ints (optional),
            Indices of `axis ^ 1` to apply function over.
    ...
    def map_axis_partitions(
        ...
        partitions : NumPy array
            The partitions of my_happy_modin Frame.
        map_func : callable
            The function to apply.
        ...
        -------
        NumPy array
            An array of new partitions for my_happy_modin Frame.
    ...
    def simple_shuffle(cls, axis, partitions, map_func, lengths):
        ...
        -------
        NumPy array
            An array of new partitions for a my_happy_modin Frame.
        """
        preprocessed_map_func = cls.preprocess_func(map_func)
    ...
    def binary_operation(cls, axis, left, func, right):
        ...
        ----------
            axis : int
                The axis to apply the function over (0 - rows, 1 - columns)
            left : NumPy array
                The partitions of left my_happy_modin Frame
            func : callable
                The function to apply
            right : NumPy array
                The partitions of right my_happy_modin Frame.
