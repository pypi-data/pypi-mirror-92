...
_LocationIndexerBase provide methods framework for __getitem__
  and __setitem__ that work with my_happy_modin DataFrame's internal index. Base
...
_LocIndexer and _iLocIndexer is responsible for indexer specific logic and
  ...
  will take care of translating pandas's lookup to my_happy_modin DataFrame's internal
  lookup.
...
my_happy_modin is making a copy of of the DataFrame. This behavior diverges from Pandas.
