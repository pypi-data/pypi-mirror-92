...
from my_happy_modin.backends.pandas.parsers import find_common_type_cat as find_common_type
...
class BasePandasFrame(object):
    ...
    def broadcast_apply(
        ...
        ----------
            ...
            other: BasePandasFrame
                The my_happy_modin DataFrame to broadcast.
            join_type: str (optional)
                The type of join to apply.
            preserve_labels: boolean (optional)
                Whether or not to keep labels from this my_happy_modin DataFrame.
    ...
    def broadcast_apply_full_axis(
        ...
        ----------
            ...
            func : callable
                The function to apply.
            other : others my_happy_modin frames to broadcast
            new_index : list-like (optional)
                The index of the result. We may know this in advance,
                and if not provided it must be computed.
            new_columns : list-like (optional)
        ...
        Returns
        -------
             A new my_happy_modin DataFrame
        """
    ...
    def to_pandas(self):
        """Convert a my_happy_modin DataFrame to Pandas DataFrame.
    ...
    def to_numpy(self, **kwargs):
        """
        Convert a my_happy_modin DataFrame to a 2D NumPy array.
