...
from my_happy_modin.utils import _inherit_func_docstring, _inherit_docstrings
        ...
        if item not in default_behaviors:
            if callable(method):
                ...
                def return_handler(*args, **kwargs):
                    ...
                    my_happy_modin DataFrame to pandas DataFrame, etc. Currently, pytables
                    does not accept my_happy_modin DataFrame objects, so we must convert to
                    pandas.
                    """
                    from my_happy_modin.utils import to_pandas
        ...
        if item not in default_behaviors:
            if callable(method):
                ...
                def return_handler(*args, **kwargs):
                    ...
                    my_happy_modin DataFrame to pandas DataFrame, etc.
                    """
                    from my_happy_modin.utils import to_pandas
