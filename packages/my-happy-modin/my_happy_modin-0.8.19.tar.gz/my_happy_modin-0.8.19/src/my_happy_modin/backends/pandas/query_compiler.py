...
from my_happy_modin.utils import try_cast_to_pandas, wrap_udf_function, hashable
from my_happy_modin.data_management.functions import (
    Function,
    FoldFunction,
    MapFunction,
    MapReduceFunction,
...
class PandasQueryCompiler(BaseQueryCompiler):
    ...
    def apply(self, func, axis, *args, **kwargs):
        ...
        """
        # if any of args contain my_happy_modin object, we should
