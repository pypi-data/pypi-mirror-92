...
from my_happy_modin.utils import _inherit_docstrings, to_pandas
...
class Series(BasePandasDataset):
    ...
    def searchsorted(self, value, side="left", sorter=None):
        ...
        if sorter is not None:
            # `iloc` method works slowly (https://github.com/my_happy_modin-project/my_happy_modin/issues/1903),
