...
_MSGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kCreateIndex', index=12, number=300,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kDescribeIndex', index=13, number=301,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kInsert', index=14, number=400,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kDelete', index=15, number=401,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kFlush', index=16, number=402,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kSearch', index=17, number=500,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kSearchResult', index=18, number=501,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kGetIndexState', index=19, number=502,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kGetCollectionStatistics', index=20, number=503,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kGetPartitionStatistics', index=21, number=504,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kTimeTick', index=22, number=1200,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kQueryNodeStats', index=23, number=1201,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kLoadIndex', index=24, number=1202,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kRequestID', index=25, number=1203,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kRequestTSO', index=26, number=1204,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='kAllocateSegment', index=27, number=1205,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
