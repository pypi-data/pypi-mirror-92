...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.21.1-alpha.1611277261+e92395d0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.21.1-alpha.1611277261+e92395d0`
                """)
            else:
                raise
