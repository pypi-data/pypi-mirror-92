...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.21.1-alpha.1611617683+a1031f99'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.21.1-alpha.1611617683+a1031f99`
                """)
            else:
                raise
