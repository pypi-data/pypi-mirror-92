...
class Server:
    def __init__(self,
        ...
        self._config = {
            ...
            'max_body_bytes': 1073741824 if not max_body_bytes else max_body_bytes,
            'max_header_bytes': 1048576 if not max_header_bytes else max_header_bytes,
            ...
            'request_acceptance_timeout':
            10 if not request_acceptance_timeout else request_acceptance_timeout,
    ...
    def start(self):
        ...
        logging.info(f'config: {json.dumps(self._config, indent=2)}')
