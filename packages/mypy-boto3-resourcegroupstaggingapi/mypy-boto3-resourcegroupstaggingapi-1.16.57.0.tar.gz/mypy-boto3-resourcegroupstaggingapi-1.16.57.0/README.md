...
[boto3.ResourceGroupsTaggingAPI 1.16.57](https://boto3.amazonaws.com/v1/documentation/api/1.16.57/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
compatible with
