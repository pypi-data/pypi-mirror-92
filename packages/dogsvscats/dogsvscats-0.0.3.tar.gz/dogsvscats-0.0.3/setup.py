...
# Package meta-data.
name = "dogsvscats"
description = "A simple toy project using dogs-vs-cats Kaggle competition"
url = "https://github.com/albertoburgosplaza/dogsvscats"
email = "albertoburgosplaza@gmail.com"
...
def get_version():
    version_file = os.path.join(current_dir, "dogsvscats", "__init__.py")
