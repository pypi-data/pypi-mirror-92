...
"F":"gs"},"spline":{"t":"bool","v":False,
"F":"gs"},"symbol":{"t":"ICurveSymbol","v":None,
"F":"gs"},"_HashCode":{"t":"S","v":"","F":"g"},
"propertyType":{"t":"S","v":"IRenderPolyline","F":"g"}}
class IRenderPolyline(IRenderGeometry):
	...
	def spline(self):
		if hasattr(self,"_HashCode") is False:
			return
		PropsValueData = glodata.PropsValueDataGet(self._HashCode)
		return PropsValueData["spline"]

	@spline.setter
	def spline(self,val):
		PropsTypeData =  glodata.PropsTypeDataGet(self._HashCode)
		PropsValueData = glodata.PropsValueDataGet(self._HashCode)
		CM.addPropsValue(PropsValueData.get("_HashCode"), "spline", val)
		args = {}
		args["spline"] = PropsTypeData.get("spline")
		args["spline"]["v"] = val
		JsonData = CM.setJsonData("set_",PropsValueData.get("_HashCode"),"spline", args)
		wsObj.postMessage({"propertyType": PropsTypeData["propertyType"]["v"],"_HashCode": PropsValueData["_HashCode"]},"spline",JsonData)
