...
class IQueryFilter:
	...
	def initParam(self,args):
		self.filterType=args.get("filterType")
		self.idsFilter=args.get("idsFilter")
		self.resultBeginIndex=args.get("resultBeginIndex")
		self.resultLimit=args.get("resultLimit")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IQueryFilter, self).__setattr__(name, value)
