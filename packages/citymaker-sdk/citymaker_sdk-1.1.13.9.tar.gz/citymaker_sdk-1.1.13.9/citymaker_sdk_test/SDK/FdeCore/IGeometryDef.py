...
class IGeometryDef:
	...
	def initParam(self,args):
		self.avgNumPoints=args.get("avgNumPoints")
		self.envelope=args.get("envelope")
		self.geometryColumnType=args.get("geometryColumnType")
		self.hasId=args.get("hasId")
		self.hasM=args.get("hasM")
		self.hasRenderIndex=args.get("hasRenderIndex")
		self.hasSpatialIndex=args.get("hasSpatialIndex")
		self.hasZ=args.get("hasZ")
		self.maxM=args.get("maxM")
		self.minM=args.get("minM")
		self.vertexAttribute=args.get("vertexAttribute")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IGeometryDef, self).__setattr__(name, value)
