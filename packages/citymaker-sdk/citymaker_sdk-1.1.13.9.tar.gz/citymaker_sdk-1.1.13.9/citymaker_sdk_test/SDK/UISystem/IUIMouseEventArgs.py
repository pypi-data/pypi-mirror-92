...
class IUIMouseEventArgs(IUIWindowEventArgs):
	...
	def initParam(self,args):
		...
		self.clickCount=args.get("clickCount")
		self.moveDelta=args.get("moveDelta")
		self.position=args.get("position")
		self.sysKeys=args.get("sysKeys")
		self.wheelChange=args.get("wheelChange")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IUIMouseEventArgs, self).__setattr__(name, value)
