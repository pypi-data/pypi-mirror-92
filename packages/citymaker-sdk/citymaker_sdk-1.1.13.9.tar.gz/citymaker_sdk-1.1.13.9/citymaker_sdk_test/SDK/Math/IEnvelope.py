...
class IEnvelope:
	...
	def initParam(self,args):
		self.Center=args.get("Center")
		self.Depth=args.get("Depth")
		self.Height=args.get("Height")
		self.MaxX=args.get("MaxX")
		self.MaxY=args.get("MaxY")
		self.MaxZ=args.get("MaxZ")
		self.MinX=args.get("MinX")
		self.MinY=args.get("MinY")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IEnvelope, self).__setattr__(name, value)
