...
class IRangeRenderRule(IRenderRule):
	...
	def initParam(self,args):
		self.includeMax=args.get("includeMax")
		self.includeMin=args.get("includeMin")
		self.maxValue=args.get("maxValue")
		self.minValue=args.get("minValue")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IRangeRenderRule, self).__setattr__(name, value)
