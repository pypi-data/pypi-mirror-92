...
"propertyType":{"t":"S","v":"ITerrainRegularPolygon","F":"g"}}
class ITerrainRegularPolygon(IRenderable):
	def __init__(self,args):
		CM.AddProps(self, Props, args)
		#CM.AddDefineProperty(self, Props)

	def initParam(self,args):
		self.fillStyle=args.get("fillStyle")
		self.lineStyle=args.get("lineStyle")
		self.numberOfSegments=args.get("numberOfSegments")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ITerrainRegularPolygon, self).__setattr__(name, value)
