...
class IPointSymbol(IGeometrySymbol):
	...
	def initParam(self,args):
		...
		self.occlusionTransparent=args.get("occlusionTransparent")
		self.shrinkDistanceRatio=args.get("shrinkDistanceRatio")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IPointSymbol, self).__setattr__(name, value)
