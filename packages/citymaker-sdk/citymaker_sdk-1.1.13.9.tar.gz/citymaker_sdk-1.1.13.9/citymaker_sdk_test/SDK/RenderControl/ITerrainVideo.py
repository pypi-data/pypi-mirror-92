...
class ITerrainVideo(IRenderable):
	...
	def initParam(self,args):
		...
		self.aspectRatio=args.get("aspectRatio")
		self.canSeek=args.get("canSeek")
		self.displayMode=args.get("displayMode")
		self.farClip=args.get("farClip")
		self.fieldOfView=args.get("fieldOfView")
		self.playbackRate=args.get("playbackRate")
		self.playLoop=args.get("playLoop")
		self.playStatus=args.get("playStatus")
		self.playVideoOnStartup=args.get("playVideoOnStartup")
		self.position=args.get("position")
		self.videoLength=args.get("videoLength")
		self.videoOpacity=args.get("videoOpacity")
		self.videoPosition=args.get("videoPosition")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ITerrainVideo, self).__setattr__(name, value)
