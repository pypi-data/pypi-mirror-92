...
class IComplexParticleEffect(IRenderable):
	...
	def initParam(self,args):
		...
		self.emissionRate=args.get("emissionRate")
		self.isAlive=args.get("isAlive")
		self.position=args.get("position")
		self.rotateAngle=args.get("rotateAngle")
		self.scalingFactor=args.get("scalingFactor")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IComplexParticleEffect, self).__setattr__(name, value)
