...
class ISurfaceSymbol(IGeometrySymbol):
	...
	def initParam(self,args):
		self.boundarySymbol=args.get("boundarySymbol")
		self.color=args.get("color")
		self.enableLight=args.get("enableLight")
		self.repeatLengthU=args.get("repeatLengthU")
		self.repeatLengthV=args.get("repeatLengthV")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ISurfaceSymbol, self).__setattr__(name, value)
