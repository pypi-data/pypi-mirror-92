...
class IImageryLayer(IRenderable):
	...
	def initParam(self,args):
		self.bandCount=args.get("bandCount")
		self.drawOrder=args.get("drawOrder")
		self.imageHeight=args.get("imageHeight")
		self.imageWidth=args.get("imageWidth")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IImageryLayer, self).__setattr__(name, value)
