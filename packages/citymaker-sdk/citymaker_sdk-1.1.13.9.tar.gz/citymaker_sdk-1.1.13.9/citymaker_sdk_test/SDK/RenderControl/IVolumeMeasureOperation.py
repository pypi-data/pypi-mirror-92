...
class IVolumeMeasureOperation(IOperation):
	...
	def initParam(self,args):
		self.polygonFixedHeight=args.get("polygonFixedHeight")
		self.polygonFixedHeightEnabled=args.get("polygonFixedHeightEnabled")
		self.sampleGridLength=args.get("sampleGridLength")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IVolumeMeasureOperation, self).__setattr__(name, value)
