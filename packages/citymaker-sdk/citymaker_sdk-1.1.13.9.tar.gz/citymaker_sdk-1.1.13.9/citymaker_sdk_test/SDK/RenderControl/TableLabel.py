...
from SDK.RenderControl.ITableLabel import ITableLabel
Props={"_HashCode":{"t":"S","v":"","F":"g"},
"propertyType":{"t":"S","v":"TableLabel","F":"g"}}
class TableLabel(ITableLabel):
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(TableLabel, self).__setattr__(name, value)
