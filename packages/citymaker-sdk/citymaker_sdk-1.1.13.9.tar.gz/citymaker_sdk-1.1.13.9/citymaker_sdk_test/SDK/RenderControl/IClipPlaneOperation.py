...
class IClipPlaneOperation(IOperation):
	...
	def initParam(self,args):
		self.boxLineColor=args.get("boxLineColor")
		self.boxSurfaceColor=args.get("boxSurfaceColor")
		self.clipPlaneOperationType=args.get("clipPlaneOperationType")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IClipPlaneOperation, self).__setattr__(name, value)
