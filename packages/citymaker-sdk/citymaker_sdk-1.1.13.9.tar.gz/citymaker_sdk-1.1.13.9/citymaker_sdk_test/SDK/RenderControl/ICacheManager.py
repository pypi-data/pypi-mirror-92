...
class ICacheManager:
	...
	def initParam(self,args):
		self.fileCacheEnabled=args.get("fileCacheEnabled")
		self.fileCacheSize=args.get("fileCacheSize")
		self.memoryCacheEnabled=args.get("memoryCacheEnabled")
		self.memoryCacheSize=args.get("memoryCacheSize")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ICacheManager, self).__setattr__(name, value)
