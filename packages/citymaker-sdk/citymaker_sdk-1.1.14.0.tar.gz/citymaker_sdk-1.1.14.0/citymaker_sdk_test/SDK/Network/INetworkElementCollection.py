...
"propertyType":{"t":"S","v":"INetworkElementCollection","F":"g"}}
class INetworkElementCollection:
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(INetworkElementCollection, self).__setattr__(name, value)
