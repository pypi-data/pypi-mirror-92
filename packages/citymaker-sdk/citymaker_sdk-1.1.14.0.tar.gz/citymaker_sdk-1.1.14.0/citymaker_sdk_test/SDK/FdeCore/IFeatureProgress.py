...
class IFeatureProgress:
	...
	def initParam(self,args):
		self.currentFeatureCount=args.get("currentFeatureCount")
		self.currentOperation=args.get("currentOperation")
		self.operationCount=args.get("operationCount")
		self.operations=args.get("operations")
		self.totalFeatureCount=args.get("totalFeatureCount")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IFeatureProgress, self).__setattr__(name, value)
