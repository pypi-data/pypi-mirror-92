...
class IHeatMap(IRenderable):
	...
	def initParam(self,args):
		self.attenRadius=args.get("attenRadius")
		self.maxHeatValue=args.get("maxHeatValue")
		self.minHeatValue=args.get("minHeatValue")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IHeatMap, self).__setattr__(name, value)
