...
class IOverlayUILabel(IRenderable):
	...
	def initParam(self,args):
		self.isEnable=args.get("isEnable")
		self.maxViewHeight=args.get("maxViewHeight")
		self.minViewHeight=args.get("minViewHeight")
		self.worldPosition=args.get("worldPosition")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IOverlayUILabel, self).__setattr__(name, value)
