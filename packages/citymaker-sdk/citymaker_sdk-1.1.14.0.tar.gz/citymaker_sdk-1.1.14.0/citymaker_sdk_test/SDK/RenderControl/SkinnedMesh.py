...
from SDK.RenderControl.ISkinnedMesh import ISkinnedMesh
Props={"_HashCode":{"t":"S","v":"","F":"g"},
"propertyType":{"t":"S","v":"SkinnedMesh","F":"g"}}
class SkinnedMesh(ISkinnedMesh):
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(SkinnedMesh, self).__setattr__(name, value)
