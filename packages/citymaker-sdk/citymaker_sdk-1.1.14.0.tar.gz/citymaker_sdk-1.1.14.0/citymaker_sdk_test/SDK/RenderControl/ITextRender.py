...
class ITextRender:
	...
	def initParam(self,args):
		self.dynamicPlacement=args.get("dynamicPlacement")
		self.minimizeOverlap=args.get("minimizeOverlap")
		self.removeDuplicate=args.get("removeDuplicate")
		self.renderType=args.get("renderType")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ITextRender, self).__setattr__(name, value)
