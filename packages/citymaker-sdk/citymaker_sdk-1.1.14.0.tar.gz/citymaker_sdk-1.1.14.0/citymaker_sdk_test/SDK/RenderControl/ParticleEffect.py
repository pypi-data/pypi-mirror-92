...
from SDK.RenderControl.IParticleEffect import IParticleEffect
Props={"_HashCode":{"t":"S","v":"","F":"g"},
"propertyType":{"t":"S","v":"ParticleEffect","F":"g"}}
class ParticleEffect(IParticleEffect):
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ParticleEffect, self).__setattr__(name, value)
