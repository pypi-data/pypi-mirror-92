...
class IPosition:
	...
	def initParam(self,args):
		self.altitude=args.get("altitude")
		self.altitudeType=args.get("altitudeType")
		self.cartesian=args.get("cartesian")
		self.distance=args.get("distance")
		self.heading=args.get("heading")
		self.roll=args.get("roll")
		self.tilt=args.get("tilt")
		self.x=args.get("x")
		self.y=args.get("y")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IPosition, self).__setattr__(name, value)
