...
from SDK.RenderControl.IComplexParticleEffect import IComplexParticleEffect
Props={"_HashCode":{"t":"S","v":"","F":"g"},
"propertyType":{"t":"S","v":"ComplexParticleEffect","F":"g"}}
class ComplexParticleEffect(IComplexParticleEffect):
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ComplexParticleEffect, self).__setattr__(name, value)
