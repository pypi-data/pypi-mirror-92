...
class IRenderModelPointPickResult(IPickResult):
	...
	def initParam(self,args):
		self.drawGroupIndex=args.get("drawGroupIndex")
		self.primitiveIndex=args.get("primitiveIndex")
		self.renderModelPoint=args.get("renderModelPoint")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IRenderModelPointPickResult, self).__setattr__(name, value)
