...
class ITextSymbol:
	...
	def initParam(self,args):
		self.drawLine=args.get("drawLine")
		self.lineColor=args.get("lineColor")
		self.lockMode=args.get("lockMode")
		self.marginColor=args.get("marginColor")
		self.marginHeight=args.get("marginHeight")
		self.marginWidth=args.get("marginWidth")
		self.maxVisualDistance=args.get("maxVisualDistance")
		self.minVisualDistance=args.get("minVisualDistance")
		self.pivotAlignment=args.get("pivotAlignment")
		self.priority=args.get("priority")
		self.textAttribute=args.get("textAttribute")
		self.verticalOffset=args.get("verticalOffset")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ITextSymbol, self).__setattr__(name, value)
