...
class ITerrainVideoConfig:
	...
	def initParam(self,args):
		self.maxRealtimeTVNum=args.get("maxRealtimeTVNum")
		self.maxVisualFieldTVNum=args.get("maxVisualFieldTVNum")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ITerrainVideoConfig, self).__setattr__(name, value)
