...
class IPolygon(ISurfacePatch):
	...
	def initParam(self,args):
		self.exteriorRing=args.get("exteriorRing")
		self.interiorRingCount=args.get("interiorRingCount")
		self.isCoplanar=args.get("isCoplanar")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(IPolygon, self).__setattr__(name, value)
