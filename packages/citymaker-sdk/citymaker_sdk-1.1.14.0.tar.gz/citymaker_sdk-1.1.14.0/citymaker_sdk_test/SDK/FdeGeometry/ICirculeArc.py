...
class ICirculeArc(ICurve):
	...
	def initParam(self,args):
		self.CenterPoint=args.get("CenterPoint")
		self.CentralAngle=args.get("CentralAngle")
		self.ChordHeight=args.get("ChordHeight")
		self.ChordLength=args.get("ChordLength")
		self.IsLine=args.get("IsLine")
		self.IsMinor=args.get("IsMinor")
		self.IsPoint=args.get("IsPoint")
		self.PointOnArc=args.get("PointOnArc")
	...
	def __setattr__(self,name,value):
		if name in Props:
			...
			if F.find("s") > -1:
				...
				super(ICirculeArc, self).__setattr__(name, value)
