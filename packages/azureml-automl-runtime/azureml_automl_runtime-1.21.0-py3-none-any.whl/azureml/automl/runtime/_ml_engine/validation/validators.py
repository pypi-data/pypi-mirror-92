...
Data = Union[RawExperimentData, MaterializedTabularData]
...
class AbstractMaterializedTabularDataValidator(AbstractDataValidator):
    """
    ...
    def validate(self, data: Data) -> None:
        ...
        Contract.assert_value(data, "tabular_data",
                              reference_code=AbstractMaterializedTabularDataValidator._REFERENCE_CODE)
        Contract.assert_type(data, "tabular_data", expected_types=MaterializedTabularData,
                             reference_code=AbstractMaterializedTabularDataValidator._REFERENCE_CODE)

        tabular_data = cast(MaterializedTabularData, data)
    ...
    def validate_tabular_data(self, tabular_data: MaterializedTabularData) -> None:
        """
        Run validations on the provided materialized tabular data.
