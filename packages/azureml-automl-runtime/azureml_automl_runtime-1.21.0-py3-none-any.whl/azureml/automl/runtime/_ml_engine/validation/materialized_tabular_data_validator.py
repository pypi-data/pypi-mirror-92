...
from azureml.automl.runtime._ml_engine.validation.validators import AbstractMaterializedTabularDataValidator
from azureml.automl.runtime.shared import utilities as runtime_utilities

logger = logging.getLogger(__name__)


class MaterializedTabularDataValidator(AbstractMaterializedTabularDataValidator):
    """
    ...
    def __init__(
        ...
        :param is_streaming_enabled: If streaming is enabled for this task.
        """
        self._task_type = task_type
        self._primary_metric = primary_metric
        self._is_onnx_enabled = is_onnx_enabled
        self._is_featurization_enabled = is_featurization_required
        self._is_streaming_enabled = is_streaming_enabled

    def validate_tabular_data(self, tabular_data: MaterializedTabularData) -> None:
        """
    ...
    def _check_data_can_be_preprocessed(self, tabular_data: MaterializedTabularData) -> None:
        ...
        # Streaming uses sub-sampling + streaming does not use pandas, so skip any validations
    ...
    def _check_target_column(self, y: np.ndarray) -> None:
        ...
        # todo Find a good way to remove this flag
