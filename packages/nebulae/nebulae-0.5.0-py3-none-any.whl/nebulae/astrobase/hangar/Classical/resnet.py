...
class Bottleneck(dock.Craft):
    def __init__(self, in_shape, neck_chs, body_chs, stride=1, dsample=False, engine=None, scope='BOTTLENECK'):
        super(Bottleneck, self).__init__(engine, scope)
        H, W, C = in_shape
...
class ResBlock(dock.Craft):
    def __init__(self, in_shape, nchs, nblock, stride=1, width_multp=4, engine=None, scope='RESBLOCK'):
        super(ResBlock, self).__init__(engine, scope)
        H, W, C = in_shape
        self.nblock = nblock
        self.layer_1 = Bottleneck(in_shape, nchs, C*width_multp, stride, dsample=True)
...
class Resnet_V2(dock.Craft):
    def __init__(self, in_shape, nblocks, engine, scope='RESNET_V2'):
        super(Resnet_V2, self).__init__(engine, scope)
        H, W, C = in_shape
...
class Resnet_V2_50(dock.Craft):
    def __init__(self, in_shape, engine, scope='RESNET_V2_50'):
        super(Resnet_V2_50, self).__init__(engine, scope)
        self.backbone = Resnet_V2(in_shape, [3, 4, 6, 3], engine)
...
class Resnet_V2_101(dock.Craft):
    def __init__(self, in_shape, engine, scope='RESNET_V2_101'):
        super(Resnet_V2_101, self).__init__(engine, scope)
        self.backbone = Resnet_V2(in_shape, [3, 4, 23, 3], engine)
...
class Resnet_V2_152(dock.Craft):
    def __init__(self, in_shape, engine, scope='RESNET_V2_152'):
        super(Resnet_V2_152, self).__init__(engine, scope)
        self.backbone = Resnet_V2(in_shape, [3, 8, 36, 3], engine)
