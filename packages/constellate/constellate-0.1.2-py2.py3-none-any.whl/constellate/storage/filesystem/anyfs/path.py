...
def get_immediate_parent_folder_if_file(filePath):
...
def get_path_without_extension(filePath):
    """
...
def get_path_with_extension(filePath, newExtension):
    """
...
def get_path_with_parent_and_extension(filePath, newParent, newExtension):
    """
    Get path with the new extension instead
    @param filePath File Path
...
def escape_occurences(source, escape_string):
    """
