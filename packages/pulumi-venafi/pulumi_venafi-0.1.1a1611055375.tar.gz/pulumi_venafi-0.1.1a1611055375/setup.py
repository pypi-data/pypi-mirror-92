...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.1.1-alpha.1611055375+7bbcbbee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.1.1-alpha.1611055375+7bbcbbee`
                """)
            else:
                raise
