...
# Here we can optimize memory imprint of Stanza by limiting the number of processors.
# If language not defined here, default will be used.
STANZA_PROCESSOR_OPTS = {
    "default": "tokenize,pos,lemma,ner",
    # no NER for Estonian yet
    "et": "tokenize,pos,lemma"
}
...
class MLP:
    ...
    def _get_stanza_processors(lang):
        """
        Returns processor options based on language.
        """
        if lang not in STANZA_PROCESSOR_OPTS:
            return STANZA_PROCESSOR_OPTS["default"]
        else:
            return STANZA_PROCESSOR_OPTS[lang]
