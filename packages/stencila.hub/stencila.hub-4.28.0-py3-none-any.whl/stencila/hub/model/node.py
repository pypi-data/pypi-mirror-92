...
class Node(ModelNormal):
    ...
    def __init__(self, project, node, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "U6MmvbXUEZqkMeCaC94yKMNEojrPkD4Z"  # noqa: E501
