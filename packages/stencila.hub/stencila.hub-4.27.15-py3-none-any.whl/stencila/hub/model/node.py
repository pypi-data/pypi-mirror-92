...
class Node(ModelNormal):
    ...
    def __init__(self, project, node, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "BqY8F2DqExxK4u8Rq3AYH7P4rGFPKAKa"  # noqa: E501
