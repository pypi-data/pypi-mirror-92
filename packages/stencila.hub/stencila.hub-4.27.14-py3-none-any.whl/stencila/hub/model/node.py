...
class Node(ModelNormal):
    ...
    def __init__(self, project, node, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "QL8CANKL35xa5ndCk7nAH2VxU5mgKq3L"  # noqa: E501
